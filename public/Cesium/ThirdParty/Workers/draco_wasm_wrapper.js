...
$jscomp.polyfill(
  ...
  function(d) {
    return d
      ...
      : function(d) {
          d = Number(d);
          if (isNaN(d) || Infinity === d || -Infinity === d || 0 === d)
            return d;
...
$jscomp.polyfill(
  ...
  function(d) {
    ...
    g.prototype.resolveToNonPromiseObj_ = function(d) {
      ...
      'function' == typeof f
        ? this.settleSameAsThenable_(f, d)
        : this.fulfill_(d);
    };
    ...
    g.race = function(d) {
      return new g(function(f, g) {
        for (
          var u = $jscomp.makeIterator(d), w = u.next();
          !w.done;
          w = u.next()
        )
          n(w.value).callWhenSettled_(f, g);
      });
    };
    g.all = function(d) {
      ...
      return u.done
        ...
        : new g(function(d, g) {
            ...
            do
              D.push(void 0),
                Q++,
                n(u.value).callWhenSettled_(w(D.length - 1), g),
                (u = f.next());
            while (!u.done);
          });
    };
...
var DracoDecoderModule = function(d) {
    ...
    if (128 > c) {
      for (; 0 < b; )
        (c = String.fromCharCode.apply(
          String,
          T.subarray(e, e + Math.min(b, 1024)),
        )),
          (l = l ? l + c : c),
          (e += 1024),
          (b -= 1024);
  ...
  function Ma() {
    ...
    for (y = Math.max(y, ib); y < x[ba >> 2]; )
      y =
        536870912 >= y
          ? ma(2 * y, e)
          : Math.min(ma((3 * y + 2147483648) / 4, e), b);
    e = a.reallocBuffer(y);
  ...
  function qa() {
    ...
    for (var d = 0; d < l.length; d++)
      if (l[d] && a.___cxa_can_catch(l[d], c, e))
        return (e = x[e >> 2]), (b.adjusted = e), (m.setTempRet0(l[d]), e) | 0;
    e = x[e >> 2];
  ...
  function Q(e, b) {
    ...
    try {
      ...
      Q.buffer ||
        ...
        (Q.printChar = function(b, c) {
          ...
          if (0 === c || 10 === c) {
            ...
            a: {
              for (var l = (c = 0); e[l]; ) ++l;
              if (16 < l - c && e.subarray && Ua)
                c = Ua.decode(e.subarray(c, l));
              else
                for (l = ''; ; ) {
                  var d = e[c++];
                  if (!d) {
                  ...
                  if (d & 128) {
                    var g = e[c++] & 63;
                    if (192 == (d & 224))
                      l += String.fromCharCode(((d & 31) << 6) | g);
                    else {
                      var h = e[c++] & 63;
      ...
      for (b = 0; b < d; b++) {
        for (
          var h = x[(l + 8 * b) >> 2], g = x[(l + (8 * b + 4)) >> 2], k = 0;
          k < g;
          k++
        )
          Q.printChar(c, T[h + k]);
      ...
      return (
        ('undefined' !== typeof FS && Ca instanceof FS.ErrnoError) || W(Ca),
        -Ca.errno
      );
    }
  }
  ...
  var m = {
      ...
      dynCall: function(e, b, c) {
        return c && c.length
          ? a['dynCall_' + e].apply(null, [b].concat(c))
  ...
  try {
    var Ja = Function.prototype.call.bind(
  ...
  if (a.buffer) var F = a.buffer;
    ...
    'object' === typeof WebAssembly && 'function' === typeof WebAssembly.Memory
      ? ((a.wasmMemory = new WebAssembly.Memory({ initial: y / Aa })),
        (F = a.wasmMemory.buffer))
      : (F = new ArrayBuffer(y));
  D();
  x[0] = 1668509029;
  za[1] = 25459;
    ...
    function c(c, e, l) {
      ...
      if (a.instantiateWasm)
        try {
          ...
          return (
            a.printErr(
              'Module.instantiateWasm callback failed with error: ' + kb,
            ),
            !1
          );
        }
  ...
  a.asmLibraryArg = {
    ...
    ___cxa_throw: function(a, b, c) {
      ...
      A.last = a;
      'uncaught_exception' in na
        ? na.uncaught_exception++
        : (na.uncaught_exception = 1);
      throw a +
    ...
    ___syscall140: function(a, b) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof FS && ia instanceof FS.ErrnoError) || W(ia),
          -ia.errno
        );
      }
    },
    ...
    ___syscall6: function(a, b) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof FS && l instanceof FS.ErrnoError) || W(l),
          -l.errno
        );
      }
    },
  ...
  var pb = (a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function() {
    ...
    Zb = (a._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 = function() {
      return a.asm._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3.apply(
        null,
        arguments,
      );
    }),
    ...
    ac = (a._emscripten_bind_Decoder_GetAttributeInt8ForAllPoints_3 = function() {
      return a.asm._emscripten_bind_Decoder_GetAttributeInt8ForAllPoints_3.apply(
        null,
        arguments,
      );
    }),
    ...
    dc = (a._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3 = function() {
      return a.asm._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3.apply(
        null,
        arguments,
      );
    }),
    ec = (a._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3 = function() {
      return a.asm._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3.apply(
        null,
        arguments,
      );
    }),
    fc = (a._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3 = function() {
      return a.asm._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3.apply(
        null,
        arguments,
      );
    }),
    ...
    vb = (a._emscripten_bind_DracoInt16Array_DracoInt16Array_0 = function() {
      return a.asm._emscripten_bind_DracoInt16Array_DracoInt16Array_0.apply(
        null,
        arguments,
      );
    }),
    ...
    rc = (a._emscripten_bind_DracoInt16Array___destroy___0 = function() {
      return a.asm._emscripten_bind_DracoInt16Array___destroy___0.apply(
        null,
        arguments,
      );
    }),
    sc = (a._emscripten_bind_DracoInt16Array_size_0 = function() {
      return a.asm._emscripten_bind_DracoInt16Array_size_0.apply(
        null,
        arguments,
      );
    }),
    ...
    tb = (a._emscripten_bind_DracoInt8Array_DracoInt8Array_0 = function() {
      return a.asm._emscripten_bind_DracoInt8Array_DracoInt8Array_0.apply(
        null,
        arguments,
      );
    }),
    ...
    xc = (a._emscripten_bind_DracoInt8Array___destroy___0 = function() {
      return a.asm._emscripten_bind_DracoInt8Array___destroy___0.apply(
        null,
        arguments,
      );
    }),
    yc = (a._emscripten_bind_DracoInt8Array_size_0 = function() {
      return a.asm._emscripten_bind_DracoInt8Array_size_0.apply(
        null,
        arguments,
      );
    }),
    lb = (a._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0 = function() {
      return a.asm._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0.apply(
        null,
        arguments,
      );
    }),
    ...
    Ac = (a._emscripten_bind_DracoUInt16Array___destroy___0 = function() {
      return a.asm._emscripten_bind_DracoUInt16Array___destroy___0.apply(
        null,
        arguments,
      );
    }),
    Bc = (a._emscripten_bind_DracoUInt16Array_size_0 = function() {
      return a.asm._emscripten_bind_DracoUInt16Array_size_0.apply(
        null,
        arguments,
      );
    }),
    ob = (a._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0 = function() {
      return a.asm._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0.apply(
        null,
        arguments,
      );
    }),
    Cc = (a._emscripten_bind_DracoUInt32Array_GetValue_1 = function() {
      return a.asm._emscripten_bind_DracoUInt32Array_GetValue_1.apply(
        null,
        arguments,
      );
    }),
    Dc = (a._emscripten_bind_DracoUInt32Array___destroy___0 = function() {
      return a.asm._emscripten_bind_DracoUInt32Array___destroy___0.apply(
        null,
        arguments,
      );
    }),
    Ec = (a._emscripten_bind_DracoUInt32Array_size_0 = function() {
      return a.asm._emscripten_bind_DracoUInt32Array_size_0.apply(
        null,
        arguments,
      );
    }),
    ...
    Fc = (a._emscripten_bind_DracoUInt8Array_GetValue_1 = function() {
      return a.asm._emscripten_bind_DracoUInt8Array_GetValue_1.apply(
        null,
        arguments,
      );
    }),
    Gc = (a._emscripten_bind_DracoUInt8Array___destroy___0 = function() {
      return a.asm._emscripten_bind_DracoUInt8Array___destroy___0.apply(
        null,
        arguments,
      );
    }),
    Hc = (a._emscripten_bind_DracoUInt8Array_size_0 = function() {
      return a.asm._emscripten_bind_DracoUInt8Array_size_0.apply(
        null,
        arguments,
      );
    }),
    ...
    if (
      ('function' === typeof a.locateFile
        ...
        : a.memoryInitializerPrefixURL &&
          (V = a.memoryInitializerPrefixURL + V),
      pa || wa)
    ) {
      ...
      if (a.memoryInitializerRequest) {
        ...
        a.memoryInitializerRequest.response
          ? setTimeout(hb, 0)
          : a.memoryInitializerRequest.addEventListener('load', hb);
      } else gb();
    }
  a.then = function(d) {
    if (a.calledRun) d(a);
  ...
  a.exit = function(b, c) {
    if (!c || !a.noExitRuntime) {
      if (!a.noExitRuntime && ((ua = !0), (U = void 0), u(db), a.onExit))
        a.onExit(b);
      pa && process.exit(b);
      a.quit(b, new ea(b));
    }
  ...
  var k = {
    ...
    alloc: function(b, c) {
      ...
      b = (b + 7) & -8;
      k.pos + b >= k.size
        ? (f(0 < b), (k.needed += b), (c = a._malloc(b)), k.temps.push(c))
        : ((c = k.buffer + k.pos), (k.pos += b));
      return c;
    },
    copy: function(a, c, d) {
  ...
  h.prototype.GetAttributeInt8ForAllPoints = h.prototype.GetAttributeInt8ForAllPoints = function(
    a,
    c,
    d,
  ) {
  ...
  h.prototype.GetAttributeUInt8ForAllPoints = h.prototype.GetAttributeUInt8ForAllPoints = function(
    a,
    c,
    d,
  ) {
  ...
  h.prototype.GetAttributeInt16ForAllPoints = h.prototype.GetAttributeInt16ForAllPoints = function(
    a,
    c,
    d,
  ) {
  ...
  h.prototype.GetAttributeUInt16ForAllPoints = h.prototype.GetAttributeUInt16ForAllPoints = function(
    a,
    c,
    d,
  ) {
  ...
  h.prototype.GetAttributeUInt32ForAllPoints = h.prototype.GetAttributeUInt32ForAllPoints = function(
    a,
    c,
    d,
  ) {
