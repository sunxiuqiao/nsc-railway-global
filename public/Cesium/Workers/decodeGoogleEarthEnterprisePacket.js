...
define([
  ...
  var s = (function a(o, s, f) {
          ...
          function(e, t, i) {
            ...
            var r = {
                ...
                flattenChunks: function(e) {
                  ...
                  for (
                    o = new Uint8Array(n), t = r = 0, i = e.length;
                    t < i;
                    t++
                  )
          ...
          function(e, t, i) {
            ...
            (l[254] = l[254] = 1),
              (i.string2buf = function(e) {
                ...
                for (t = new f.Buf8(s), r = a = 0; a < s; r++)
                  55296 == (64512 & (i = e.charCodeAt(r))) &&
                    r + 1 < o &&
                    56320 == (64512 & (n = e.charCodeAt(r + 1))) &&
                    ((i = 65536 + ((i - 55296) << 10) + (n - 56320)), r++),
              ...
              (i.buf2string = function(e, t) {
                ...
                for (i = n = 0; i < o; )
                  if ((r = e[i++]) < 128) s[n++] = r;
                  else if (4 < (a = l[r])) (s[n++] = 65533), (i += a - 1);
                  else {
                    for (r &= 2 === a ? 31 : 3 === a ? 15 : 7; 1 < a && i < o; )
                      (r = (r << 6) | (63 & e[i++])), a--;
                    1 < a
                      ? (s[n++] = 65533)
                      : r < 65536
          ...
          function(e, t, i) {
            ...
            function H(e) {
              if (h) {
                var t;
                for (
                  u = new B.Buf32(512), d = new B.Buf32(32), t = 0;
                  t < 144;
                ...
                for (
                  D(N, e.lens, 0, 288, u, 0, e.work, { bits: 9 }), t = 0;
                  t < 32;
            ...
            function P(e, t, i, n) {
              ...
              return (
                ...
                n >= a.wsize
                  ? (B.arraySet(a.window, t, i - a.wsize, a.wsize, 0),
                    (a.wnext = 0),
                    (a.whave = a.wsize))
                  : ((r = a.wsize - a.wnext),
                    n < r && (r = n),
                    B.arraySet(a.window, t, i - n, r, a.wnext),
                    (n -= r)
                      ? (B.arraySet(a.window, t, i - n, n, 0),
                        (a.wnext = n),
                        (a.whave = a.wsize))
                      : ((a.wnext += r),
        ...
        9: [
          function(e, t, i) {
            ...
            t.exports = function(e, t, i, n, r, a, o, s) {
              ...
              if ((p < y && (y = p), 0 === p))
                return (
                  (r[a++] = 20971520), (r[a++] = 20971520), (s.bits = 1), 0
                );
              for (_ = 1; _ < p && 0 === U[_]; _++);
          ...
          function(e, t, i) {
            ...
            (o.prototype.push = function(e, t) {
              ...
              do {
                if (
                  (0 === f.avail_out &&
                    ((f.output = new c.Buf8(l)),
                    (f.next_out = 0),
                    (f.avail_out = l)),
                  (i = h.inflate(f, m.Z_NO_FLUSH)) === m.Z_NEED_DICT &&
                    u &&
                    ((s =
                      'string' == typeof u
                        ? b.string2buf(u)
                        : '[object ArrayBuffer]' === w.call(u)
                        ? new Uint8Array(u)
                        : u),
                    (i = h.inflateSetDictionary(this.strm, s))),
                  i === m.Z_BUF_ERROR && !0 === d && ((i = m.Z_OK), (d = !1)),
                  i !== m.Z_STREAM_END && i !== m.Z_OK)
                )
                ...
                f.next_out &&
                  ((0 !== f.avail_out &&
                    ...
                    ('string' === this.options.to
                      ? ((r = b.utf8border(f.output, f.next_out)),
                        (a = f.next_out - r),
                        (o = b.buf2string(f.output, r)),
                        (f.next_out = a),
                        (f.avail_out = l - a),
                        a && c.arraySet(f.output, f.output, r, a, 0),
                        this.onData(o))
                      : this.onData(c.shrinkBuf(f.output, f.next_out)))),
                  0 === f.avail_in && 0 === f.avail_out && (d = !0);
              } while (
                (0 < f.avail_in || 0 === f.avail_out) &&
                i !== m.Z_STREAM_END
              );
              return (
                i === m.Z_STREAM_END && (n = m.Z_FINISH),
                n === m.Z_FINISH
                  ? ((i = h.inflateEnd(this.strm)),
                    this.onEnd(i),
                    (this.ended = !0),
                    i === m.Z_OK)
                  : n !== m.Z_SYNC_FLUSH ||
                    (this.onEnd(m.Z_OK), !(f.avail_out = 0))
              );
            }),
    ...
    o = { METADATA: 0, TERRAIN: 1, DBROOT: 2 };
  ...
  return t(function(e, t) {
    ...
    var r = (function(e) {
      var t = new DataView(e),
        ...
        n = t.getUint32(i, !0);
      if (((i += B), n !== f && n !== l))
        throw new S.RuntimeError('Invalid magic');
      var r = t.getUint32(i, n === f);
      i += B;
      var a = new Uint8Array(e, i),
        o = s.inflate(a);
    ...
    switch (i) {
      case o.METADATA:
        return (function(e, t, i) {
          ...
          if (((r += A), 32 !== l))
            throw new S.RuntimeError('Invalid instance size.');
          ...
          if (u !== f * l + (r += A))
            throw new S.RuntimeError('Invalid dataBufferOffset');
          if (u + d + h !== t)
            throw new S.RuntimeError('Invalid packet offsets');
          for (var c = [], b = 0; b < f; ++b) {
            var m = n.getUint8(r);
            ++r, ++r;
