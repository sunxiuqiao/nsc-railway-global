...
define([
  ...
  './Plane-a6a20716',
], function(e, _, t, q, U, Y, M, G, P, l, w, Z, a) {
  'use strict';
  ...
  var s = {
    calculateACMR: function(e) {
      var t = (e = _.defaultValue(e, _.defaultValue.EMPTY_OBJECT)).indices,
        r = e.maximumIndex,
        a = _.defaultValue(e.cacheSize, 24),
        i = t.length;
      if (!_.defined(r))
        for (var n = (r = 0), s = t[n]; n < i; ) r < s && (r = s), (s = t[++n]);
      for (var o = [], u = 0; u < r + 1; u++) o[u] = 0;
      for (var p = a + 1, d = 0; d < i; ++d)
        p - o[t[d]] > a && ((o[t[d]] = p), ++p);
      return (p - a + 1) / (i / 3);
    },
  };
  s.tipsify = function(e) {
    var v,
      t = (e = _.defaultValue(e, _.defaultValue.EMPTY_OBJECT)).indices,
      r = e.maximumIndex,
      a = _.defaultValue(e.cacheSize, 24);
    function i(e, t, r, a, i, n, s) {
      for (var o, u = -1, p = -1, d = 0; d < r.length; ) {
        ...
        a[l].numLiveTriangles &&
          ((o = 0),
          i - a[l].timeStamp + 2 * a[l].numLiveTriangles <= t &&
            (o = i - a[l].timeStamp),
          (p < o || -1 === p) && ((p = o), (u = l))),
          ++d;
      }
      return -1 === u
        ? (function(e, t, r) {
            for (; 1 <= t.length; ) {
              var a = t[t.length - 1];
              if ((t.splice(t.length - 1, 1), 0 < e[a].numLiveTriangles))
                return a;
            }
            for (; v < r; ) {
    ...
    var d,
      l = [];
    for (d = 0; d < s; d++)
      l[d] = { numLiveTriangles: 0, timeStamp: 0, vertexTriangles: [] };
    for (var y = (o = 0); o < p; )
  ...
  function f(e) {
    var t = {};
    for (var r in e)
      if (e.hasOwnProperty(r) && _.defined(e[r]) && _.defined(e[r].values)) {
        var a = e[r];
  ...
  function c(e, t, r) {
    for (var a in t)
      if (t.hasOwnProperty(a) && _.defined(t[a]) && _.defined(t[a].values))
        for (var i = t[a], n = 0; n < i.componentsPerAttribute; ++n)
          e[a].values.push(i.values[r * i.componentsPerAttribute + n]);
  }
  (r.toWireframe = function(e) {
          ...
          e.indices = (function(e) {
            ...
            if (3 <= t) {
              var r = 6 * (t - 2),
                a = w.IndexDatatype.createTypedArray(t, r);
              o(a, 0, e[0], e[1], e[2]);
              for (var i = 6, n = 3; n < t; ++n, i += 6)
                o(a, i, e[n - 1], e[n], e[n - 2]);
              return a;
            }
    ...
    (r.createLineSegmentsForVectors = function(e, t, r) {
      ...
      return (
        _.defined(d) && (a = new Y.BoundingSphere(d.center, d.radius + r)),
        new G.Geometry({
          attributes: {
    ...
    (r.reorderForPreVertexCache = function(e) {
      var t = G.Geometry.computeNumberOfVertices(e),
        r = e.indices;
      if (_.defined(r)) {
          ...
          if (
            ...
            for (
              var f = v[y],
                ...
                h = M.ComponentDatatype.createTypedArray(
                  f.componentDatatype,
                  l * C,
                );
              m < t;
              ...
              var b = a[m];
              if (-1 !== b)
                for (var g = 0; g < C; g++) h[C * b + g] = c[C * m + g];
              ++m;
            }
            f.values = h;
          }
    ...
    (r.fitToUnsignedShortIndices = function(e) {
      var t = [],
        r = G.Geometry.computeNumberOfVertices(e);
      if (_.defined(e.indices) && r >= q.CesiumMath.SIXTY_FOUR_KILOBYTES) {
        var a,
          ...
          u = e.indices,
          p = u.length;
        e.primitiveType === G.PrimitiveType.TRIANGLES
          ? (a = 3)
          : e.primitiveType === G.PrimitiveType.LINES
          ? (a = 2)
          : e.primitiveType === G.PrimitiveType.POINTS && (a = 1);
        for (var d = 0; d < p; d += a) {
          for (var l = 0; l < a; ++l) {
            var v = u[d + l],
              y = i[v];
            _.defined(y) || ((y = s++), (i[v] = y), c(o, e.attributes, v)),
              n.push(y);
          }
          s + a >= q.CesiumMath.SIXTY_FOUR_KILOBYTES &&
            (t.push(
              new G.Geometry({
                attributes: o,
                indices: n,
  ...
  var m = new U.Cartesian3(),
    C = new U.Cartographic();
  r.projectTo2D = function(e, t, r, a, i) {
    for (
      var n = e.attributes[t],
        s = (i = _.defined(i) ? i : new Y.GeographicProjection()).ellipsoid,
        o = n.values,
      ...
      var l = U.Cartesian3.fromArray(o, d, m),
        v = s.cartesianToCartographic(l, C),
        y = i.project(v, m);
  ...
  r.encodeAttribute = function(e, t, r, a) {
    for (
      ...
      l.EncodedCartesian3.encode(n[p], v), (o[p] = v.high), (u[p] = v.low);
    var d = i.componentsPerAttribute;
    return (
      (e.attributes[r] = new G.GeometryAttribute({
  ...
  function i(e, t) {
    if (_.defined(t))
      for (var r = t.values, a = r.length, i = 0; i < a; i += 3)
        U.Cartesian3.unpack(r, i, n),
          Y.Matrix4.multiplyByPoint(e, n, n),
          U.Cartesian3.pack(n, r, i);
  }
  function u(e, t) {
    if (_.defined(t))
      for (var r = t.values, a = r.length, i = 0; i < a; i += 3)
        U.Cartesian3.unpack(r, i, n),
          Y.Matrix3.multiplyByVector(e, n, n),
          (n = U.Cartesian3.normalize(n, n)),
          U.Cartesian3.pack(n, r, i);
  }
  var p = new Y.Matrix4(),
    d = new Y.Matrix3();
  r.transformToWorldCoordinates = function(e) {
    ...
    i(t, r.position),
      i(t, r.prevPosition),
      i(t, r.nextPosition),
      (_.defined(r.normal) || _.defined(r.tangent) || _.defined(r.bitangent)) &&
    ...
    return (
      _.defined(a) &&
        (e.geometry.boundingSphere = Y.BoundingSphere.transform(a, t, a)),
  ...
  function y(e, t) {
    var r,
      ...
      p,
      d = e.length,
      l = (e[0].modelMatrix, _.defined(e[0][t].indices)),
      ...
      y = (function(e, t) {
        ...
        for (r in n)
          if (
            ...
            u &&
              (i[r] = new G.GeometryAttribute({
                componentDatatype: s.componentDatatype,
                componentsPerAttribute: s.componentsPerAttribute,
                normalize: s.normalize,
                values: M.ComponentDatatype.createTypedArray(
                  s.componentDatatype,
                  o,
                ),
              }));
    ...
    for (r in y)
      if (y.hasOwnProperty(r))
        for (s = y[r].values, a = n = 0; a < d; ++a)
          for (u = (o = e[a][t].attributes[r].values).length, i = 0; i < u; ++i)
            s[n++] = o[i];
    if (l) {
      var f = 0;
      for (a = 0; a < d; ++a) f += e[a][t].indices.length;
      var c = G.Geometry.computeNumberOfVertices(
          new G.Geometry({
            attributes: y,
    ...
    if (_.defined(T))
      for (U.Cartesian3.divideByScalar(T, d, T), a = 0; a < d; ++a) {
        ...
        var P =
          U.Cartesian3.magnitude(U.Cartesian3.subtract(A.center, T, O)) +
          A.radius;
        x < P && (x = P);
      }
  ...
  r.combineInstances = function(e) {
    for (var t = [], r = [], a = e.length, i = 0; i < a; ++i) {
      var n = e[i];
      _.defined(n.geometry)
        ? t.push(n)
        : _.defined(n.westHemisphereGeometry) &&
          _.defined(n.eastHemisphereGeometry) &&
          r.push(n);
    }
    var s = [];
    return (
      ...
      0 < r.length &&
        (s.push(y(r, 'westHemisphereGeometry')),
        s.push(y(r, 'eastHemisphereGeometry'))),
      s
    );
  };
  ...
  r.computeNormal = function(e) {
    var t,
      ...
      a = e.attributes,
      i = a.position.values,
      n = a.position.values.length / 3,
      s = r.length,
      o = new Array(n),
      u = new Array(s / 3),
      p = new Array(s);
    for (t = 0; t < n; t++)
      o[t] = { indexOffset: 0, count: 0, currentCount: 0 };
    var d = 0;
    for (t = 0; t < s; t += 3) {
      var l = r[t],
        v = r[t + 1],
    ...
    for (t = d = 0; t < s; t += 3) {
      ...
      (p[b] = d),
        C.currentCount++,
        (p[(b = (C = o[r[t + 1]]).indexOffset + C.currentCount)] = d),
        C.currentCount++,
        (p[(b = (C = o[r[t + 2]]).indexOffset + C.currentCount)] = d),
        C.currentCount++,
        d++;
    }
    ...
    for (t = 0; t < n; t++) {
      ...
      if (((C = o[t]), U.Cartesian3.clone(U.Cartesian3.ZERO, T), 0 < C.count)) {
        for (d = 0; d < C.count; d++)
          U.Cartesian3.add(T, u[p[C.indexOffset + d]], T);
        U.Cartesian3.equalsEpsilon(
          U.Cartesian3.ZERO,
          T,
          q.CesiumMath.EPSILON10,
        ) && U.Cartesian3.clone(u[p[C.indexOffset]], T);
      }
      U.Cartesian3.equalsEpsilon(
        U.Cartesian3.ZERO,
        T,
    ...
    return (
      (e.attributes.normal = new G.GeometryAttribute({
        componentDatatype: M.ComponentDatatype.FLOAT,
        componentsPerAttribute: 3,
        values: g,
      })),
  ...
  r.computeTangentAndBitangent = function(e) {
    ...
    var E = new Float32Array(3 * p),
      N = new Float32Array(3 * p);
    for (t = 0; t < p; t++) {
      (a = (r = 3 * t) + 1), (i = r + 2);
      var L = U.Cartesian3.fromArray(o, r, R),
        z = U.Cartesian3.fromArray(l, r, F),
        D = U.Cartesian3.dot(L, z);
      U.Cartesian3.multiplyByScalar(L, D, V),
        U.Cartesian3.normalize(U.Cartesian3.subtract(z, V, z), z),
        (E[r] = z.x),
        (E[a] = z.y),
        (E[i] = z.z),
        U.Cartesian3.normalize(U.Cartesian3.cross(L, z, z), z),
        (N[r] = z.x),
        (N[a] = z.y),
        (N[i] = z.z);
    }
    return (
      (e.attributes.tangent = new G.GeometryAttribute({
        componentDatatype: M.ComponentDatatype.FLOAT,
        componentsPerAttribute: 3,
        values: E,
      })),
    ...
    switch (e.primitiveType) {
      case G.PrimitiveType.TRIANGLE_FAN:
        return (function(e) {
          ...
          (r[0] = 1), (r[1] = 0), (r[2] = 2);
          for (var a = 3, i = 3; i < t; ++i)
            (r[a++] = i - 1), (r[a++] = 0), (r[a++] = i);
          return (
            (e.indices = r), (e.primitiveType = G.PrimitiveType.TRIANGLES), e
          );
        })(e);
      case G.PrimitiveType.TRIANGLE_STRIP:
        return (function(e) {
  ...
  function b(e, t) {
    Math.abs(e.y) < q.CesiumMath.EPSILON6 &&
      (e.y = t ? -q.CesiumMath.EPSILON6 : q.CesiumMath.EPSILON6);
  }
  r.compressVertices = function(e) {
    ...
    if (_.defined(a)) {
      var i = a.values;
      r = i.length / 3;
      var n = new Float32Array(2 * r),
        s = 0;
      for (t = 0; t < r; ++t)
        U.Cartesian3.fromArray(i, 3 * t, D),
          U.Cartesian3.equals(D, U.Cartesian3.ZERO)
            ? (s += 2)
            : ((H = P.AttributeCompression.octEncodeInRange(D, 65535, H)),
              (n[s++] = H.x),
              (n[s++] = H.y));
      return (
        (e.attributes.compressedAttributes = new G.GeometryAttribute({
          componentDatatype: M.ComponentDatatype.FLOAT,
    ...
    for (t = 0; t < r; ++t) {
      ...
      var x = 3 * t;
      p && _.defined(y) && _.defined(f)
        ? (U.Cartesian3.fromArray(l, x, D),
          U.Cartesian3.fromArray(y, x, B),
          U.Cartesian3.fromArray(f, x, k),
          P.AttributeCompression.octPack(D, B, k, z),
          (A[T++] = z.x),
          (A[T++] = z.y))
        : (p &&
            (U.Cartesian3.fromArray(l, x, D),
            (A[T++] = P.AttributeCompression.octEncodeFloat(D))),
          C &&
            (U.Cartesian3.fromArray(y, x, D),
            (A[T++] = P.AttributeCompression.octEncodeFloat(D))),
          h &&
            (U.Cartesian3.fromArray(f, x, D),
            (A[T++] = P.AttributeCompression.octEncodeFloat(D))));
    }
    return (
      (e.attributes.compressedAttributes = new G.GeometryAttribute({
      ...
      h && delete e.attributes.bitangent,
      C && delete e.attributes.tangent,
      e
    );
  };
  ...
  function A(e, t, r, a) {
    U.Cartesian3.add(
      e,
      U.Cartesian3.multiplyByScalar(
        U.Cartesian3.subtract(t, e, g),
        e.y / (e.y - t.y),
        g,
      ),
      r,
    ...
    if (!(0 <= e.x || 0 <= t.x || 0 <= r.x)) {
      !(function(e, t, r) {
        if (0 !== e.y && 0 !== t.y && 0 !== r.y)
          return b(e, e.y < 0), b(t, t.y < 0), b(r, r.y < 0);
        var a = Math.abs(e.y),
          i = Math.abs(t.y),
          n = Math.abs(r.y),
          s =
            (i < a
              ? n < a
                ? q.CesiumMath.sign(e.y)
                : q.CesiumMath.sign(r.y)
              : n < i
              ? q.CesiumMath.sign(t.y)
              : q.CesiumMath.sign(r.y)) < 0;
        b(e, s), b(t, s), b(r, s);
      })(e, t, r);
      var a = e.y < 0,
        i = t.y < 0,
      ...
      return (
        ...
        (u.length = 3),
        (1 != s && 2 != s) ||
          ((u[3] = W), (u[4] = X), (u[5] = j), (u[6] = J), (u.length = 7)),
        K
      );
    }
  }
  function $(e, t) {
    ...
    if (0 !== r.position.values.length) {
      for (var a in r)
        if (r.hasOwnProperty(a) && _.defined(r[a]) && _.defined(r[a].values)) {
          var i = r[a];
          i.values = M.ComponentDatatype.createTypedArray(
            i.componentDatatype,
            i.values,
          );
        }
      ...
      return (
        (e.indices = w.IndexDatatype.createTypedArray(n, e.indices)),
        t &&
          (e.boundingSphere = Y.BoundingSphere.fromVertices(r.position.values)),
        e
      );
    }
  }
  ...
  function re(v, y) {
    ...
    return function(e, t, r, a, i, n, s, o) {
      var u = v.fromArray(i, e * y, f),
        p = v.fromArray(i, t * y, c),
        d = v.fromArray(i, r * y, m);
      v.multiplyByScalar(u, a.x, u),
        v.multiplyByScalar(p, a.y, p),
        v.multiplyByScalar(d, a.z, d);
      var l = v.add(u, p, u);
      v.add(l, d, l), o && v.normalize(l, l), v.pack(l, n, s * y);
    };
  }
  var ae = re(Y.Cartesian4, 4),
    ie = re(U.Cartesian3, 3),
    ne = re(U.Cartesian2, 2),
    ...
    if (
      ...
      var m = (function(e, t, r, a, i) {
        ...
        if ((_.defined(i) || (i = new U.Cartesian3()), _.defined(t.z))) {
          if (U.Cartesian3.equalsEpsilon(e, t, q.CesiumMath.EPSILON14))
            return U.Cartesian3.clone(U.Cartesian3.UNIT_X, i);
          if (U.Cartesian3.equalsEpsilon(e, r, q.CesiumMath.EPSILON14))
            return U.Cartesian3.clone(U.Cartesian3.UNIT_Y, i);
          if (U.Cartesian3.equalsEpsilon(e, a, q.CesiumMath.EPSILON14))
            return U.Cartesian3.clone(U.Cartesian3.UNIT_Z, i);
          (n = U.Cartesian3.subtract(r, t, x)),
            (s = U.Cartesian3.subtract(a, t, S)),
            (o = U.Cartesian3.subtract(e, t, I)),
            (u = U.Cartesian3.dot(n, n)),
            (p = U.Cartesian3.dot(n, s)),
            (d = U.Cartesian3.dot(n, o)),
            (l = U.Cartesian3.dot(s, s)),
            (v = U.Cartesian3.dot(s, o));
        } else {
          if (U.Cartesian2.equalsEpsilon(e, t, q.CesiumMath.EPSILON14))
            return U.Cartesian3.clone(U.Cartesian3.UNIT_X, i);
          if (U.Cartesian2.equalsEpsilon(e, r, q.CesiumMath.EPSILON14))
            return U.Cartesian3.clone(U.Cartesian3.UNIT_Y, i);
          if (U.Cartesian2.equalsEpsilon(e, a, q.CesiumMath.EPSILON14))
            return U.Cartesian3.clone(U.Cartesian3.UNIT_Z, i);
          (n = U.Cartesian2.subtract(r, t, x)),
            (s = U.Cartesian2.subtract(a, t, S)),
            (o = U.Cartesian2.subtract(e, t, I)),
            (u = U.Cartesian2.dot(n, n)),
            (p = U.Cartesian2.dot(n, s)),
            (d = U.Cartesian2.dot(n, o)),
        ...
        a,
        U.Cartesian3.fromArray(i, 3 * e, oe),
        U.Cartesian3.fromArray(i, 3 * t, ue),
        U.Cartesian3.fromArray(i, 3 * r, pe),
        de,
      );
      if (
        (_.defined(n) && ie(e, t, r, m, n, l.normal.values, c, !0),
        _.defined(p))
      ) {
        var C,
          h = U.Cartesian3.fromArray(p, 3 * e, oe),
          b = U.Cartesian3.fromArray(p, 3 * t, ue),
          g = U.Cartesian3.fromArray(p, 3 * r, pe);
        U.Cartesian3.multiplyByScalar(h, m.x, h),
          U.Cartesian3.multiplyByScalar(b, m.y, b),
          U.Cartesian3.multiplyByScalar(g, m.z, g),
          U.Cartesian3.equals(h, U.Cartesian3.ZERO) &&
          U.Cartesian3.equals(b, U.Cartesian3.ZERO) &&
          U.Cartesian3.equals(g, U.Cartesian3.ZERO)
            ? (((C = oe).x = 0), (C.y = 0), (C.z = 0))
            : ((C = U.Cartesian3.add(h, b, h)),
              U.Cartesian3.add(C, g, C),
              U.Cartesian3.normalize(C, C)),
          U.Cartesian3.pack(C, l.extrudeDirection.values, 3 * c);
      }
      if (
        (_.defined(d) && se(e, t, r, m, d, l.applyOffset.values, c),
        _.defined(s) && ie(e, t, r, m, s, l.tangent.values, c, !0),
        _.defined(o) && ie(e, t, r, m, o, l.bitangent.values, c, !0),
        _.defined(u) && ne(e, t, r, m, u, l.st.values, c),
        0 < y)
      )
        for (var A = 0; A < y; A++) {
          var T = v[A];
  ...
  function ce(e) {
    var t = e.geometry,
      r = t.attributes,
      a = r.position.values,
      i = _.defined(r.normal) ? r.normal.values : void 0,
      n = _.defined(r.bitangent) ? r.bitangent.values : void 0,
      s = _.defined(r.tangent) ? r.tangent.values : void 0,
      o = _.defined(r.st) ? r.st.values : void 0,
      u = _.defined(r.extrudeDirection) ? r.extrudeDirection.values : void 0,
      p = _.defined(r.applyOffset) ? r.applyOffset.values : void 0,
      d = t.indices,
      l = [];
    for (var v in r)
      r.hasOwnProperty(v) && !fe[v] && _.defined(r[v]) && l.push(v);
    var y,
      f,
      c,
      m,
    ...
    g.length = a.length / 3;
    var A = [];
    for (A.length = a.length / 3, m = 0; m < g.length; ++m)
      (g[m] = -1), (A[m] = -1);
    var T = d.length;
    for (m = 0; m < T; m += 3) {
      var x = d[m],
        ...
        O = U.Cartesian3.fromArray(a, 3 * w),
        E = Q(S, I, O);
      if (_.defined(E) && 3 < E.positions.length)
        for (
          var N = E.positions, L = E.indices, z = L.length, D = 0;
          D < z;
          ++D
        ) {
          var M = L[D],
          ...
          (c =
            ...
            le(
              ...
              C,
              r,
              ye(y, f, c, d, M < 3 ? m + M : -1, G),
            );
        }
      else
        _.defined(E) &&
          ((S = E.positions[0]), (I = E.positions[1]), (O = E.positions[2])),
          (c =
            S.y < 0
              ? ((y = b.attributes), (f = b.indices), g)
              : ((y = h.attributes), (f = h.indices), A)),
          le(x, P, w, S, a, i, s, n, o, u, p, y, l, C, r, ye(y, f, c, d, m, S)),
          le(
            x,
            P,
            w,
  ...
  function be(e, t, r, a, i, n, s) {
    if (_.defined(s)) {
      ...
      U.Cartesian3.equalsEpsilon(o, r, q.CesiumMath.EPSILON10)
        ? (n.applyOffset.values[i] = s[e])
        : (n.applyOffset.values[i] = s[t]);
    }
  }
  function ge(e) {
    var t,
      ...
      a = r.attributes,
      i = a.position.values,
      n = _.defined(a.applyOffset) ? a.applyOffset.values : void 0,
      s = r.indices,
      o = ee(r),
      u = ee(r),
      p = s.length,
    ...
    d.length = i.length / 3;
    var l = [];
    for (l.length = i.length / 3, t = 0; t < d.length; ++t)
      (d[t] = -1), (l[t] = -1);
    for (t = 0; t < p; t += 2) {
      var v = s[t],
        y = s[t + 1],
        f = U.Cartesian3.fromArray(i, 3 * v, oe),
        c = U.Cartesian3.fromArray(i, 3 * y, ue);
      Math.abs(f.y) < q.CesiumMath.EPSILON6 &&
        (f.y < 0
          ? (f.y = -q.CesiumMath.EPSILON6)
          : (f.y = q.CesiumMath.EPSILON6)),
        Math.abs(c.y) < q.CesiumMath.EPSILON6 &&
          (c.y < 0
            ? (c.y = -q.CesiumMath.EPSILON6)
            : (c.y = q.CesiumMath.EPSILON6));
      var m = o.attributes,
        C = o.indices,
        h = l,
      ...
      if (_.defined(T)) {
        var x = U.Cartesian3.multiplyByScalar(
          U.Cartesian3.UNIT_Y,
          5 * q.CesiumMath.EPSILON9,
          Ce,
        );
        f.y < 0 &&
        ...
        be(v, y, f, i, ye(m, C, h, s, t, f), m, n),
          be(v, y, P, i, ye(m, C, h, s, -1, P), m, n),
          U.Cartesian3.negate(x, x),
          U.Cartesian3.add(T, x, P),
          be(v, y, P, i, ye(b, g, A, s, -1, P), b, n),
          be(v, y, c, i, ye(b, g, A, s, t + 1, c), b, n);
      } else {
        var w, S, I;
        (I =
          f.y < 0
          ...
          be(v, y, f, i, ye(w, S, I, s, t, f), w, n),
          be(v, y, c, i, ye(w, S, I, s, t + 1, c), w, n);
      }
    }
    te(e, u, o);
  }
    ...
    for (
      ...
      if (!(0 < o.x)) {
        ...
        ((o.y < 0 && 0 < p.y) || (0 < o.y && p.y < 0)) &&
          (s + 3 < n
            ? ((i[s] = r[s + 3]), (i[s + 1] = r[s + 4]), (i[s + 2] = r[s + 5]))
            : U.Cartesian3.pack(o, i, s));
      }
    }
  }
  var Le = 5 * q.CesiumMath.EPSILON9,
    ze = q.CesiumMath.EPSILON6;
  (r.splitLongitude = function(e) {
    ...
    if (
      ...
      (0 < r.center.x - r.radius ||
        Y.BoundingSphere.intersectPlane(r, a.Plane.ORIGIN_ZX_PLANE) !==
          Y.Intersect.INTERSECTING)
    )
      return e;
    if (t.geometryType !== G.GeometryType.NONE)
        ...
        case G.GeometryType.POLYLINES:
          !(function(e) {
            var t,
              ...
              n = i.attributes,
              s = n.position.values,
              o = n.prevPosition.values,
              u = n.nextPosition.values,
              p = n.expandAndWidth.values,
              d = _.defined(n.st) ? n.st.values : void 0,
              l = _.defined(n.color) ? n.color.values : void 0,
              v = ee(i),
              y = ee(i),
              f = !1,
              c = s.length / 3;
            for (t = 0; t < c; t += 4) {
              var m = t,
                C = t + 2,
                h = U.Cartesian3.fromArray(s, 3 * m, xe),
              ...
              if (_.defined(P)) {
                f = !0;
                var w = U.Cartesian3.multiplyByScalar(
                  U.Cartesian3.UNIT_Y,
                  Le,
                  Ie,
                );
                ...
                g.position.values.push(h.x, h.y, h.z, h.x, h.y, h.z),
                  ...
                  g.prevPosition.values.push(h.x, h.y, h.z, h.x, h.y, h.z),
                ...
                var I = U.Cartesian2.fromArray(p, 2 * m, Ae),
                  O = Math.abs(I.y);
                g.expandAndWidth.values.push(-1, O, 1, O),
                  g.expandAndWidth.values.push(-1, -O, 1, -O),
                  T.expandAndWidth.values.push(-1, O, 1, O),
                  T.expandAndWidth.values.push(-1, -O, 1, -O);
                var E = U.Cartesian3.magnitudeSquared(
                  U.Cartesian3.subtract(P, h, we),
                );
                if (
                  ((E /= U.Cartesian3.magnitudeSquared(
                    U.Cartesian3.subtract(b, h, we),
                  )),
                  _.defined(l))
                ) {
                  var N = Y.Cartesian4.fromArray(l, 4 * m, Ee),
                    L = Y.Cartesian4.fromArray(l, 4 * C, Ee),
                    z = q.CesiumMath.lerp(N.x, L.x, E),
                    D = q.CesiumMath.lerp(N.y, L.y, E),
                    M = q.CesiumMath.lerp(N.z, L.z, E),
                    G = q.CesiumMath.lerp(N.w, L.w, E);
                  for (r = 4 * m; r < 4 * m + 8; ++r) g.color.values.push(l[r]);
                  for (
                    g.color.values.push(z, D, M, G),
                      g.color.values.push(z, D, M, G),
                      T.color.values.push(z, D, M, G),
                      T.color.values.push(z, D, M, G),
                      r = 4 * C;
                    r < 4 * C + 8;
                    ++r
                ...
                if (_.defined(d)) {
                  var R = U.Cartesian2.fromArray(d, 2 * m, Ae),
                    ...
                    F = q.CesiumMath.lerp(R.x, V.x, E);
                  for (r = 2 * m; r < 2 * m + 4; ++r) g.st.values.push(d[r]);
                  for (
                    g.st.values.push(F, R.y),
                      g.st.values.push(F, V.y),
                      T.st.values.push(F, R.y),
                      T.st.values.push(F, V.y),
                      r = 2 * C;
                    r < 2 * C + 4;
                    ++r
                  )
                ...
                for (
                  k =
                    h.y < 0
                      ? ((B = y.attributes), y.indices)
                      : ((B = v.attributes), v.indices),
                    B.position.values.push(h.x, h.y, h.z),
                    B.position.values.push(h.x, h.y, h.z),
                    B.position.values.push(b.x, b.y, b.z),
                    B.position.values.push(b.x, b.y, b.z),
                    r = 3 * t;
                  r < 3 * t + 12;
                  ++r
                )
                  B.prevPosition.values.push(o[r]),
                    B.nextPosition.values.push(u[r]);
                for (r = 2 * t; r < 2 * t + 8; ++r)
                  B.expandAndWidth.values.push(p[r]),
                    _.defined(d) && B.st.values.push(d[r]);
                if (_.defined(l))
                  for (r = 4 * t; r < 4 * t + 16; ++r)
                    B.color.values.push(l[r]);
                (a = B.position.values.length / 3 - 4),
                  k.push(a, a + 2, a + 1),
                  k.push(a + 1, a + 2, a + 3);
              }
            }
      ...
      h(t),
        t.primitiveType === G.PrimitiveType.TRIANGLES
          ? ce(e)
          : t.primitiveType === G.PrimitiveType.LINES && ge(e);
    return e;
  }),
