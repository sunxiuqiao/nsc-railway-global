...
define([
  ...
  './BoxGeometry-ccced19d',
  './CylinderGeometryLibrary-3c55f845',
  './CylinderGeometry-0df2229f',
  './EllipsoidGeometry-232477be',
  './Color-06be9049',
], function(D, e, t, P, q, n, r, a, i, o, W, d, s, c, _, f, N, Y, S) {
  'use strict';
  function T(e) {
  ...
  var l = new P.Cartesian3(),
    u = q.Matrix4.packedLength + P.Cartesian3.packedLength,
    h = q.Matrix4.packedLength + 2,
    p = q.Matrix4.packedLength + P.Cartesian3.packedLength,
    b = P.Cartesian3.packedLength + 1,
    y = {
      modelMatrix: new q.Matrix4(),
      boundingVolume: new q.BoundingSphere(),
    };
  function j(e, t) {
    var n = t * u,
      r = P.Cartesian3.unpack(e, n, l);
    n += P.Cartesian3.packedLength;
    var a = q.Matrix4.unpack(e, n, y.modelMatrix);
    q.Matrix4.multiplyByScale(a, r, a);
    var i = y.boundingVolume;
    return (
      P.Cartesian3.clone(P.Cartesian3.ZERO, i.center),
      (i.radius = Math.sqrt(3)),
      y
    );
  }
  function z(e, t) {
  ...
  function J(e, t) {
    var n = t * b,
      r = e[n++],
      a = P.Cartesian3.unpack(e, n, l),
      i = q.Matrix4.fromTranslation(a, y.modelMatrix);
    ...
    if (D.defined(t)) {
      for (
        ...
        for (var w = n[k], A = o.length, O = 0; O < A; O += 3) {
          ...
          q.Matrix4.multiplyByPoint(B, L, L),
            P.Cartesian3.subtract(L, g, L),
            P.Cartesian3.pack(L, s, 3 * v + O),
            (c[C++] = w);
        }
        ...
        (h[G] = new T({
          ...
          (p[G] = m),
          (b[G] = E),
          (y[G] = q.BoundingSphere.transform(M.boundingVolume, B)),
          (v += A / 3),
          (m += E);
      }
      (e.positionOffset = v),
  ...
  var Q = new P.Cartesian3(),
    X = new q.Matrix4();
  function $(e, t, n) {
    var r = n.length,
      a =
        2 +
        r * q.BoundingSphere.packedLength +
        1 +
        (function(e) {
    ...
    (i[o++] = e), (i[o++] = r);
    for (var d = 0; d < r; ++d)
      q.BoundingSphere.pack(n[d], i, o), (o += q.BoundingSphere.packedLength);
    var s = t.length;
    i[o++] = s;
    for (var c = 0; c < s; ++c) {
      var f = t[c];
      S.Color.pack(f.color, i, o),
        (o += S.Color.packedLength),
        (i[o++] = f.offset),
        (i[o++] = f.count);
      var l = f.batchIds,
        u = l.length;
  ...
  return d(function(e, t) {
    var n = D.defined(e.boxes) ? new Float32Array(e.boxes) : void 0,
      ...
      i = D.defined(e.cylinderBatchIds)
        ? new Uint16Array(e.cylinderBatchIds)
        : void 0,
      o = D.defined(e.ellipsoids) ? new Float32Array(e.ellipsoids) : void 0,
      d = D.defined(e.ellipsoidBatchIds)
        ? new Uint16Array(e.ellipsoidBatchIds)
        : void 0,
      s = D.defined(e.spheres) ? new Float32Array(e.spheres) : void 0,
      c = D.defined(e.sphereBatchIds)
        ? new Uint16Array(e.sphereBatchIds)
        : void 0,
      f = D.defined(n) ? r.length : 0,
      l = D.defined(a) ? i.length : 0,
      u = D.defined(o) ? d.length : 0,
      h = D.defined(s) ? c.length : 0,
      p = _.BoxGeometry.getUnitBox(),
      b = N.CylinderGeometry.getUnitCylinder(),
      y = Y.EllipsoidGeometry.getUnitEllipsoid(),
      x = p.attributes.position.values,
      g = b.attributes.position.values,
    ...
    var B,
      ...
      L = new Uint16Array(C / 3),
      E = W.IndexDatatype.createTypedArray(C / 3, M),
      U = f + l + u + h,
      G = new Uint16Array(U),
      S = new Array(U),
      T = new Uint32Array(U),
    ...
    (B = e.packedBuffer),
      ...
      (A = 0),
      P.Cartesian3.unpack(w, A, Q),
      (A += P.Cartesian3.packedLength),
      q.Matrix4.unpack(w, A, X);
    var R = {
    ...
    return (
      t.push(O.buffer, L.buffer, E.buffer),
      t.push(G.buffer, T.buffer, V.buffer),
      t.push(Z.buffer),
      {
        positions: O.buffer,
