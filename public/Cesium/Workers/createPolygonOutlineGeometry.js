...
define([
  ...
  function R(e, t, i, r, o) {
    var n,
      a,
      l = D.EllipsoidTangentPlane.fromPoints(t, e).projectPointsOntoPlane(t, S);
    I.PolygonPipeline.computeWindingOrder2D(l) === I.WindingOrder.CLOCKWISE &&
    ...
    if (r)
      ...
      var d = 0;
      if (o === x.ArcType.GEODESIC)
        for (a = 0; a < s; a++)
          d += w.PolygonGeometryLibrary.subdivideLineCount(
            t[a],
            t[(a + 1) % s],
            i,
          );
      else if (o === x.ArcType.RHUMB)
        for (a = 0; a < s; a++)
          d += w.PolygonGeometryLibrary.subdivideRhumbLineCount(
            e,
            t[a],
            t[(a + 1) % s],
            i,
      ...
      for (n = new Float64Array(3 * d), a = 0; a < s; a++) {
        var c;
        o === x.ArcType.GEODESIC
          ? (c = w.PolygonGeometryLibrary.subdivideLine(
              t[a],
              t[(a + 1) % s],
              i,
              k,
          ...
          : o === x.ArcType.RHUMB &&
            (c = w.PolygonGeometryLibrary.subdivideRhumbLine(
              e,
              t[a],
              t[(a + 1) % s],
              i,
        ...
        for (var f = c.length, g = 0; g < f; ++g) n[y++] = c[g];
      }
    }
  ...
  function N(e, t, i, r, o) {
    ...
    if (r)
      ...
      if (o === x.ArcType.GEODESIC)
        for (a = 0; a < s; a++)
          c += w.PolygonGeometryLibrary.subdivideLineCount(
            t[a],
            t[(a + 1) % s],
            i,
          );
        ...
        for (a = 0; a < s; a++)
          c += w.PolygonGeometryLibrary.subdivideRhumbLineCount(
            e,
            t[a],
            t[(a + 1) % s],
            i,
          );
      for (n = new Float64Array(3 * c * 2), a = 0; a < s; ++a) {
        var f;
        (y[a] = u / 3),
          o === x.ArcType.GEODESIC
            ? (f = w.PolygonGeometryLibrary.subdivideLine(
                t[a],
                t[(a + 1) % s],
                i,
                k,
            ...
            : o === x.ArcType.RHUMB &&
              (f = w.PolygonGeometryLibrary.subdivideRhumbLine(
                e,
                t[a],
                t[(a + 1) % s],
                i,
        ...
        for (var g = f.length, h = 0; h < g; ++h) n[u++] = f[h];
      }
    }
    s = n.length / 6;
    var m = y.length,
  ...
  function f(e) {
    var t = e.polygonHierarchy,
      i = v.defaultValue(e.ellipsoid, c.Ellipsoid.WGS84),
      r = v.defaultValue(e.granularity, E.CesiumMath.RADIANS_PER_DEGREE),
      o = v.defaultValue(e.perPositionHeight, !1),
      n = o && v.defined(e.extrudedHeight),
      a = v.defaultValue(e.arcType, x.ArcType.GEODESIC),
    ...
    (this._ellipsoid = c.Ellipsoid.clone(i)),
      ...
      (this.packedLength =
        w.PolygonGeometryLibrary.computeHierarchyPackedLength(t) +
        c.Ellipsoid.packedLength +
        8);
  }
  f.pack = function(e, t, i) {
    return (
      (i = v.defaultValue(i, 0)),
      (i = w.PolygonGeometryLibrary.packPolygonHierarchy(
        e._polygonHierarchy,
        t,
        i,
      )),
      ...
      (t[i++] = e._arcType),
      (t[i++] = v.defaultValue(e._offsetAttribute, -1)),
      (t[i] = e.packedLength),
      t
    );
  };
  var g = c.Ellipsoid.clone(c.Ellipsoid.UNIT_SPHERE),
    h = { polygonHierarchy: {} };
  return (
    (f.unpack = function(e, t, i) {
      ...
      var o = c.Ellipsoid.unpack(e, t, g);
    ...
    (f.fromPositions = function(e) {
      return new f({
        polygonHierarchy: {
          positions: (e = v.defaultValue(e, v.defaultValue.EMPTY_OBJECT))
            .positions,
        },
        height: e.height,
    ...
    (f.createGeometry = function(e) {
      ...
      if (0 !== a.length) {
        var l,
          ...
          y,
          u = [],
          p = E.CesiumMath.chordLength(i, t.maximumRadius),
          d = e._height,
          c = e._extrudedHeight;
        if (
          e._perPositionHeightExtrude ||
          !E.CesiumMath.equalsEpsilon(d, c, 0, E.CesiumMath.EPSILON2)
        )
          for (y = 0; y < a.length; y++) {
            if (
              ...
              var f = l.geometry.attributes.position.values.length / 3,
                g = new Uint8Array(f);
              (g =
                e._offsetAttribute === C.GeometryOffsetAttribute.TOP
                  ? C.arrayFill(g, 1, 0, f / 2)
                  : ((s =
                      e._offsetAttribute === C.GeometryOffsetAttribute.NONE
                        ? 0
                        : 1),
                    C.arrayFill(g, s))),
          ...
          for (y = 0; y < a.length; y++) {
            if (
              (((l = R(
                ...
                o,
                n,
              )).geometry.attributes.position.values = I.PolygonPipeline.scaleToGeodeticHeight(
              ...
              (s =
                e._offsetAttribute === C.GeometryOffsetAttribute.NONE ? 0 : 1),
                C.arrayFill(m, s),
                (l.geometry.attributes.applyOffset = new G.GeometryAttribute({
                  componentDatatype: _.ComponentDatatype.UNSIGNED_BYTE,
                  componentsPerAttribute: 1,
