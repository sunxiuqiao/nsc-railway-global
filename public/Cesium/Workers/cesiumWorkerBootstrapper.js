      ...
      void 0 === require ||
        ...
        (req = requirejs = function(e, t, i, r) {
          ...
          return (
            ...
            (n =
              (n = getOwn(contexts, a)) || (contexts[a] = req.s.newContext(a))),
            o && n.configure(o),
            n.require(e, t, i)
          );
        }),
        ...
        if (
          ...
          e: for (o = (n = e.split('/')).length; 0 < o; --o) {
            if (((s = n.slice(0, o).join('/')), l))
              for (a = l.length; 0 < a; --a)
                if (
                  (r = (r = getOwn(h, l.slice(0, a).join('/'))) && getOwn(r, s))
                ) {
                  (c = r), (d = o);
                  break e;
                }
      ...
      return (
                  ...
                  if (
                    ...
                    (this.exports = n),
                      this.map.isDefine &&
                        ...
                        ((m[i] = n),
                        req.onResourceLoad &&
                          req.onResourceLoad(l, this.map, this.depMaps)),
                      P(i),
                      (this.defined = !0);
                  }
                  (this.defining = !1),
                ...
                bind(this, function(e) {
                  ...
                  return this.map.unnormalized
                    ? (e.normalize &&
                      ...
                      M(
                        (t = S(u.prefix + '!' + n, this.map.parentMap)),
                        'defined',
                        bind(this, function(e) {
                          this.init(
                            [],
        ...
        ((l = {
          ...
          configure: function(e) {
            ...
            eachProp(e, function(e, t) {
              r[t] ? (g[t] || (g[t] = {}), mixin(g[t], e, !0, !0)) : (g[t] = e);
            }),
              e.bundles &&
            ...
            return (
              ...
              mixin(s, {
                ...
                specified: function(e) {
                  return (
                    (e = S(e, o, !1, !0).id), hasProp(m, e) || hasProp(p, e)
                  );
                },
              }),
              o ||
          ...
          nameToUrl: function(e, t, i) {
            ...
            if (req.jsExtRegExp.test(e)) a = e + (t || '');
              ...
              for (r = g.paths, o = (n = e.split('/')).length; 0 < o; --o)
