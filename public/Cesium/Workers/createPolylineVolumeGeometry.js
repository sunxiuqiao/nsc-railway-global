...
define([
  ...
  var v = {};
  function B(e, t) {
    c.defined(v[e]) || ((v[e] = !0), console.warn(c.defaultValue(t, e)));
  }
  function b(e) {
    ...
    var r = 1 + t.length * u.Cartesian3.packedLength;
    (r += 1 + n.length * u.Cartesian2.packedLength),
      (this.packedLength =
        r + u.Ellipsoid.packedLength + g.VertexFormat.packedLength + 2);
  }
  (B.geometryOutlines =
    ...
    (b.pack = function(e, t, n) {
      ...
      var i = e._positions,
        a = i.length;
      for (t[n++] = a, r = 0; r < a; ++r, n += u.Cartesian3.packedLength)
        u.Cartesian3.pack(i[r], t, n);
      var o = e._shape;
      for (
        a = o.length, t[n++] = a, r = 0;
        r < a;
        ++r, n += u.Cartesian2.packedLength
      )
        u.Cartesian2.pack(o[r], t, n);
      return (
  ...
  b.unpack = function(e, t, n) {
    ...
    var i = e[t++],
      a = new Array(i);
    for (r = 0; r < i; ++r, t += u.Cartesian3.packedLength)
      a[r] = u.Cartesian3.unpack(e, t);
    i = e[t++];
    var o = new Array(i);
    for (r = 0; r < i; ++r, t += u.Cartesian2.packedLength)
      o[r] = u.Cartesian2.unpack(e, t);
  ...
  return (
    (b.createGeometry = function(e) {
      var t = e._positions,
        ...
        r = e._shape;
      if (
        ((r = m.PolylineVolumeGeometryLibrary.removeDuplicatesFromShape(r)),
        !(n.length < 2 || r.length < 3))
      ) {
        S.PolygonPipeline.computeWindingOrder2D(r) ===
          S.WindingOrder.CLOCKWISE && r.reverse();
        var i = p.BoundingRectangle.fromPoints(r, x);
        return (function(e, t, n, r) {
          ...
          var a,
            ...
            u = e.length / 3,
            g = (u - 2 * c) / (2 * c),
            y = S.PolygonPipeline.triangulate(t),
            m = (g - 1) * c * 6 + 2 * y.length,
            h = O.IndexDatatype.createTypedArray(u, m),
            f = 2 * c,
            v = 0;
          for (a = 0; a < g - 1; a++) {
            for (o = 0; o < c - 1; o++)
          ...
          if (r.st || r.tangent || r.bitangent) {
            ...
            for (a = 0; a < g; a++) {
              for (
                b = a * _, E = x * (t[0].y + k), P[C++] = b, P[C++] = E, o = 1;
                o < c;
                o++
              )
                (E = x * (t[o].y + k)),
          ...
          if (
            (r.normal && (T = I.GeometryPipeline.computeNormal(T)),
          ...
          m.PolylineVolumeGeometryLibrary.computePositions(n, r, i, e, !0),
          r,
          i,
          e._vertexFormat,
        );
