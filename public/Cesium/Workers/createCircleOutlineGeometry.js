...
define([
  ...
  './EllipseOutlineGeometry-95ed33fb',
], function(l, e, i, n, t, r, s, o, a, c, u, d, m, p) {
  'use strict';
  function y(e) {
    var i = (e = l.defaultValue(e, l.defaultValue.EMPTY_OBJECT)).radius,
      t = {
        center: e.center,
        semiMajorAxis: i,
        semiMinorAxis: i,
    ...
    (this._ellipseGeometry = new p.EllipseOutlineGeometry(t)),
  ...
  return (
    (y.unpack = function(e, i, t) {
      ...
      return (
        (G.center = n.Cartesian3.clone(r._center, G.center)),
        (G.ellipsoid = n.Ellipsoid.clone(r._ellipsoid, G.ellipsoid)),
        (G.height = r._height),
        (G.extrudedHeight = r._extrudedHeight),
        (G.granularity = r._granularity),
        (G.numberOfVerticalLines = r._numberOfVerticalLines),
        l.defined(t)
          ? ((G.semiMajorAxis = r._semiMajorAxis),
            (G.semiMinorAxis = r._semiMinorAxis),
            (t._ellipseGeometry = new p.EllipseOutlineGeometry(G)),
            t)
          : ((G.radius = r._semiMajorAxis), new y(G))
      );
    }),
    ...
    function(e, i) {
      return (
        l.defined(i) && (e = y.unpack(e, i)),
        (e._ellipseGeometry._center = n.Cartesian3.clone(
          e._ellipseGeometry._center,
        )),
        (e._ellipseGeometry._ellipsoid = n.Ellipsoid.clone(
