...
define([
  ...
  './EllipseGeometry-5bbb43be',
], function(o, e, t, a, i, r, n, s, l, d, m, c, u, p, y, _, h, G, x, f, g) {
  'use strict';
  function b(e) {
    var t = (e = o.defaultValue(e, o.defaultValue.EMPTY_OBJECT)).radius,
      i = {
        center: e.center,
        semiMajorAxis: t,
        semiMinorAxis: t,
    ...
    (this._ellipseGeometry = new g.EllipseGeometry(i)),
  ...
  return (
    (b.unpack = function(e, t, i) {
      var r = g.EllipseGeometry.unpack(e, t, v);
      return (
        (E.center = a.Cartesian3.clone(r._center, E.center)),
        (E.ellipsoid = a.Ellipsoid.clone(r._ellipsoid, E.ellipsoid)),
        (E.height = r._height),
        (E.extrudedHeight = r._extrudedHeight),
        (E.granularity = r._granularity),
        (E.vertexFormat = G.VertexFormat.clone(
          r._vertexFormat,
          E.vertexFormat,
        )),
        (E.stRotation = r._stRotation),
        (E.shadowVolume = r._shadowVolume),
        o.defined(i)
          ? ((E.semiMajorAxis = r._semiMajorAxis),
            (E.semiMinorAxis = r._semiMinorAxis),
            (i._ellipseGeometry = new g.EllipseGeometry(E)),
            i)
          : ((E.radius = r._semiMajorAxis), new b(E))
      );
    }),
    ...
    function(e, t) {
      return (
        o.defined(t) && (e = b.unpack(e, t)),
        (e._ellipseGeometry._center = a.Cartesian3.clone(
          e._ellipseGeometry._center,
        )),
        (e._ellipseGeometry._ellipsoid = a.Ellipsoid.clone(
