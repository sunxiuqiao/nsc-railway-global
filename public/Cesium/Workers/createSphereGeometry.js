...
define([
...
], function(a, e, t, o, r, i, n, s, c, d, l, m, u, p) {
  'use strict';
  function y(e) {
    var t = a.defaultValue(e.radius, 1),
      r = {
    ...
    (this._ellipsoidGeometry = new p.EllipsoidGeometry(r)),
  ...
  return (
    (y.unpack = function(e, t, r) {
      ...
      return (
        (f.vertexFormat = u.VertexFormat.clone(
          i._vertexFormat,
          f.vertexFormat,
        )),
        (f.stackPartitions = i._stackPartitions),
        (f.slicePartitions = i._slicePartitions),
        a.defined(r)
          ? (o.Cartesian3.clone(i._radii, f.radii),
            (r._ellipsoidGeometry = new p.EllipsoidGeometry(f)),
            r)
          : ((f.radius = i._radii.x), new y(f))
      );
    }),
