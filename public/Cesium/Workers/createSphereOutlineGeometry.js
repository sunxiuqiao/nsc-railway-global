...
define([
  ...
  './EllipsoidOutlineGeometry-b5fa4dda',
], function(n, e, i, a, t, r, s, o, d, c, l, u, m) {
  'use strict';
  function p(e) {
    var i = n.defaultValue(e.radius, 1),
      t = {
        radii: new a.Cartesian3(i, i, i),
        stackPartitions: e.stackPartitions,
        slicePartitions: e.slicePartitions,
        subdivisions: e.subdivisions,
      };
    (this._ellipsoidGeometry = new m.EllipsoidOutlineGeometry(t)),
  ...
  var y = new m.EllipsoidOutlineGeometry(),
    G = {
      radius: void 0,
  ...
  return (
    (p.unpack = function(e, i, t) {
      ...
      return (
        (G.stackPartitions = r._stackPartitions),
        (G.slicePartitions = r._slicePartitions),
        (G.subdivisions = r._subdivisions),
        n.defined(t)
          ? (a.Cartesian3.clone(r._radii, G.radii),
            (t._ellipsoidGeometry = new m.EllipsoidOutlineGeometry(G)),
            t)
          : ((G.radius = r._radii.x), new p(G))
      );
    }),
