...
define([
  ...
  (V.fromSpherical = function(e, t) {
    ...
    var n = e.clock,
      a = e.cone,
      r = R.defaultValue(e.magnitude, 1),
      i = r * Math.sin(a);
    return (
      (t.x = i * Math.cos(n)),
      (t.y = i * Math.sin(n)),
    ...
    (V.packArray = function(e, t) {
      var n = e.length,
        a = 3 * n;
      if (R.defined(t)) {
        if (!Array.isArray(t) && t.length !== a)
          throw new i.DeveloperError(
            'If result is a typed array, it must have exactly array.length * 3 elements',
          );
        t.length !== a && (t.length = a);
      } else t = new Array(a);
      for (var r = 0; r < n; ++r) V.pack(e[r], t, 3 * r);
      return t;
    }),
  ...
  (V.distance = function(e, t) {
    return V.subtract(e, t, n), V.magnitude(n);
  }),
    (V.distanceSquared = function(e, t) {
      return V.subtract(e, t, n), V.magnitudeSquared(n);
    }),
    ...
    (V.abs = function(e, t) {
      return (
        (t.x = Math.abs(e.x)), (t.y = Math.abs(e.y)), (t.z = Math.abs(e.z)), t
      );
    });
  var r = new V();
  V.lerp = function(e, t, n, a) {
    return (
      V.multiplyByScalar(t, n, r),
      (a = V.multiplyByScalar(e, 1 - n, a)),
      V.add(r, a, a)
    );
  };
  var u = new V(),
  ...
  V.angleBetween = function(e, t) {
    V.normalize(e, u), V.normalize(t, o);
    var n = V.dot(u, o),
      a = V.magnitude(V.cross(u, o, u));
    return Math.atan2(a, n);
  };
  var a = new V();
  (V.mostOrthogonalAxis = function(e, t) {
    var n = V.normalize(e, a);
    return (
      V.abs(n, n),
      (t =
        n.x <= n.y
    ...
    (V.equalsEpsilon = function(e, t, n, a) {
      return (
        ...
        (R.defined(e) &&
          R.defined(t) &&
          b.CesiumMath.equalsEpsilon(e.x, t.x, n, a) &&
          b.CesiumMath.equalsEpsilon(e.y, t.y, n, a) &&
          b.CesiumMath.equalsEpsilon(e.z, t.z, n, a))
      );
    }),
    ...
    (V.fromDegrees = function(e, t, n, a, r) {
      return (
        (e = b.CesiumMath.toRadians(e)),
        (t = b.CesiumMath.toRadians(t)),
        V.fromRadians(e, t, n, a, r)
      );
    });
  var d = new V(),
    s = new V(),
  ...
  (V.fromRadians = function(e, t, n, a, r) {
    n = R.defaultValue(n, 0);
    var i = R.defined(a) ? a.radiiSquared : h,
      u = Math.cos(t);
    (d.x = u * Math.cos(e)),
      (d.y = u * Math.sin(e)),
      (d.z = Math.sin(t)),
    ...
    (V.UNIT_X = Object.freeze(new V(1, 0, 0))),
    (V.UNIT_Y = Object.freeze(new V(0, 1, 0))),
    (V.UNIT_Z = Object.freeze(new V(0, 0, 1))),
  ...
  function l(e, t, n, a, r) {
    var i = e.x,
      ...
      m = l + f + c,
      y = Math.sqrt(1 / m),
      p = V.multiplyByScalar(e, y, I);
    if (m < a) return isFinite(y) ? V.clone(p, r) : void 0;
    var g = n.x,
      x = n.y,
      M = n.z,
      w = E;
    ...
    var v,
      ...
      q,
      O,
      T = ((1 - y) * V.magnitude(e)) / (0.5 * V.magnitude(w)),
      A = 0;
    do {
      A =
        (v =
          ...
          c * (O = (z = 1 / (1 + T * M)) * z) -
          1) /
        (-2 * (l * (S * _) * g + f * (q * C) * x + c * (O * z) * M));
    } while (Math.abs(v) > b.CesiumMath.EPSILON12);
    return R.defined(r)
      ? ((r.x = i * _), (r.y = u * C), (r.z = o * z), r)
      : new V(i * _, u * C, o * z);
  }
  function f(e, t, n) {
    (this.longitude = R.defaultValue(e, 0)),
      (this.latitude = R.defaultValue(t, 0)),
      (this.height = R.defaultValue(n, 0));
  }
  (f.fromRadians = function(e, t, n, a) {
    return (
      (n = R.defaultValue(n, 0)),
      R.defined(a)
        ? ((a.longitude = e), (a.latitude = t), (a.height = n), a)
        : new f(e, t, n)
    );
  }),
  ...
  function M(e, t, n, a) {
    (t = R.defaultValue(t, 0)),
      ...
      (e._radiiToTheFourth = new V(
        t * t * t * t,
        n * n * n * n,
        a * a * a * a,
      )),
      (e._oneOverRadii = new V(
        0 === t ? 0 : 1 / t,
        0 === n ? 0 : 1 / n,
        0 === a ? 0 : 1 / a,
      )),
      ...
      (e._centerToleranceSquared = b.CesiumMath.EPSILON1),
      0 !== e._radiiSquared.z &&
  ...
  (f.fromCartesian = function(e, t, n) {
    var a = R.defined(t) ? t.oneOverRadii : p,
      r = R.defined(t) ? t.oneOverRadiiSquared : g,
      i = l(e, a, r, R.defined(t) ? t._centerToleranceSquared : x, m);
    if (R.defined(i)) {
      var u = V.multiplyComponents(i, r, c);
      u = V.normalize(u, u);
      var o = V.subtract(e, i, y),
        d = Math.atan2(u.y, u.x),
        s = Math.asin(u.z),
        h = b.CesiumMath.sign(V.dot(o, e)) * V.magnitude(o);
      return R.defined(n)
      ...
      if (R.defined(e))
        return R.defined(t)
          ? ((t.longitude = e.longitude),
            ...
            (t.height = e.height),
            t)
          : new f(e.longitude, e.latitude, e.height);
    }),
    ...
    (w.fromCartesian3 = function(e, t) {
      return (
        R.defined(t) || (t = new w()), R.defined(e) && M(t, e.x, e.y, e.z), t
      );
    }),
    (w.WGS84 = Object.freeze(new w(6378137, 6378137, 6356752.314245179))),
    (w.UNIT_SPHERE = Object.freeze(new w(1, 1, 1))),
    (w.MOON = Object.freeze(
      new w(
        b.CesiumMath.LUNAR_RADIUS,
        b.CesiumMath.LUNAR_RADIUS,
        b.CesiumMath.LUNAR_RADIUS,
      ),
    )),
    ...
    (w.packedLength = V.packedLength),
    (w.pack = function(e, t, n) {
      return (n = R.defaultValue(n, 0)), V.pack(e._radii, t, n), t;
    }),
    ...
    (w.prototype.geocentricSurfaceNormal = V.normalize),
    (w.prototype.geodeticSurfaceNormalCartographic = function(e, t) {
      var n = e.longitude,
        a = e.latitude,
        r = Math.cos(a),
        i = r * Math.cos(n),
  ...
  (w.prototype.cartographicToCartesian = function(e, t) {
    ...
    this.geodeticSurfaceNormalCartographic(e, n),
      V.multiplyComponents(this._radiiSquared, n, a);
    ...
    (w.prototype.cartographicArrayToCartesianArray = function(e, t) {
      ...
      for (var a = 0; a < n; a++)
        t[a] = this.cartographicToCartesian(e[a], t[a]);
      return t;
    });
  var C = new V(),
    z = new V(),
    S = new V();
  function q(e, t, n, a) {
    (this.west = R.defaultValue(e, 0)),
      (this.south = R.defaultValue(t, 0)),
      (this.east = R.defaultValue(n, 0)),
      (this.north = R.defaultValue(a, 0));
  }
  (w.prototype.cartesianToCartographic = function(e, t) {
    var n = this.scaleToGeodeticSurface(e, z);
    if (R.defined(n)) {
      var a = this.geodeticSurfaceNormal(n, C),
        r = V.subtract(e, n, S),
        i = Math.atan2(a.y, a.x),
        u = Math.asin(a.z),
        o = b.CesiumMath.sign(V.dot(r, e)) * V.magnitude(r);
      return R.defined(t)
    ...
    (w.prototype.cartesianArrayToCartographicArray = function(e, t) {
      ...
      R.defined(t) ? (t.length = n) : (t = new Array(n));
      for (var a = 0; a < n; ++a)
        t[a] = this.cartesianToCartographic(e[a], t[a]);
      return t;
    }),
    ...
    (w.prototype.transformPositionToScaledSpace = function(e, t) {
      return (
        R.defined(t) || (t = new V()),
        V.multiplyComponents(e, this._oneOverRadii, t)
      );
    }),
    (w.prototype.transformPositionFromScaledSpace = function(e, t) {
      return (
        R.defined(t) || (t = new V()), V.multiplyComponents(e, this._radii, t)
      );
    }),
    (w.prototype.equals = function(e) {
      return this === e || (R.defined(e) && V.equals(this._radii, e._radii));
    }),
    ...
    (q.computeWidth = function(e) {
      var t = e.east,
        n = e.west;
      return t < n && (t += b.CesiumMath.TWO_PI), t - n;
    }),
    ...
    (q.fromDegrees = function(e, t, n, a, r) {
      return (
        (e = b.CesiumMath.toRadians(R.defaultValue(e, 0))),
        (t = b.CesiumMath.toRadians(R.defaultValue(t, 0))),
        (n = b.CesiumMath.toRadians(R.defaultValue(n, 0))),
        (a = b.CesiumMath.toRadians(R.defaultValue(a, 0))),
        R.defined(r)
    ...
    (q.fromRadians = function(e, t, n, a, r) {
      return R.defined(r)
        ? ((r.west = R.defaultValue(e, 0)),
          (r.south = R.defaultValue(t, 0)),
          (r.east = R.defaultValue(n, 0)),
          (r.north = R.defaultValue(a, 0)),
          r)
        : new q(e, t, n, a);
    }),
    (q.fromCartographicArray = function(e, t) {
      for (
        ...
        var l =
          0 <= h.longitude ? h.longitude : h.longitude + b.CesiumMath.TWO_PI;
        (r = Math.min(r, l)), (i = Math.max(i, l));
      }
      return (
        i - r < a - n &&
          ((n = r),
          (a = i) > b.CesiumMath.PI && (a -= b.CesiumMath.TWO_PI),
          n > b.CesiumMath.PI && (n -= b.CesiumMath.TWO_PI)),
        R.defined(t)
    ...
    (q.fromCartesianArray = function(e, t, n) {
      ...
      for (
        ...
        (a = Math.min(a, l.longitude)),
          ...
          (o = Math.min(o, l.latitude)),
          (d = Math.max(d, l.latitude));
        var f =
          0 <= l.longitude ? l.longitude : l.longitude + b.CesiumMath.TWO_PI;
        (i = Math.min(i, f)), (u = Math.max(u, f));
      }
      return (
        u - i < r - a &&
          ((a = i),
          (r = u) > b.CesiumMath.PI && (r -= b.CesiumMath.TWO_PI),
          a > b.CesiumMath.PI && (a -= b.CesiumMath.TWO_PI)),
        R.defined(n)
      ...
      if (R.defined(e))
        return R.defined(t)
          ? ((t.west = e.west),
            ...
            (t.north = e.north),
            t)
          : new q(e.west, e.south, e.east, e.north);
    }),
    ...
    (q.intersection = function(e, t, n) {
      var a = e.east,
        ...
        u = t.west;
      a < r && 0 < i
        ? (a += b.CesiumMath.TWO_PI)
        : i < u && 0 < a && (i += b.CesiumMath.TWO_PI),
        a < r && u < 0
          ? (u += b.CesiumMath.TWO_PI)
          : i < u && r < 0 && (r += b.CesiumMath.TWO_PI);
      var o = b.CesiumMath.negativePiToPi(Math.max(r, u)),
        d = b.CesiumMath.negativePiToPi(Math.min(a, i));
    ...
    (q.union = function(e, t, n) {
      ...
      a < r && 0 < i
        ...
        a < r && u < 0
          ? (u += b.CesiumMath.TWO_PI)
          : i < u && r < 0 && (r += b.CesiumMath.TWO_PI);
      var o = b.CesiumMath.convertLongitudeRange(Math.min(r, u)),
        d = b.CesiumMath.convertLongitudeRange(Math.max(a, i));
      return (
        (n.west = o),
    ...
    (q.contains = function(e, t) {
      ...
      return (
        i < r &&
          ((i += b.CesiumMath.TWO_PI), n < 0 && (n += b.CesiumMath.TWO_PI)),
        (r < n || b.CesiumMath.equalsEpsilon(n, r, b.CesiumMath.EPSILON14)) &&
          (n < i || b.CesiumMath.equalsEpsilon(n, i, b.CesiumMath.EPSILON14)) &&
          a >= e.south &&
          a <= e.north
      );
    });
  ...
  (q.subsample = function(e, t, n, a) {
    ...
    for (var h = 1; h < 8; ++h)
      (s.longitude = -Math.PI + h * b.CesiumMath.PI_OVER_TWO),
        q.contains(e, s) && ((a[r] = t.cartographicToCartesian(s, a[r])), r++);
    return (
      0 === s.latitude &&
        ((s.longitude = d),
        (a[r] = t.cartographicToCartesian(s, a[r])),
    ...
    (q.MAX_VALUE = Object.freeze(
      new q(
        -Math.PI,
        -b.CesiumMath.PI_OVER_TWO,
        Math.PI,
        b.CesiumMath.PI_OVER_TWO,
      ),
    )),
    (T.fromElements = function(e, t, n) {
      return R.defined(n) ? ((n.x = e), (n.y = t), n) : new T(e, t);
    }),
    (T.fromCartesian3 = T.clone = function(e, t) {
      if (R.defined(e))
        return R.defined(t) ? ((t.x = e.x), (t.y = e.y), t) : new T(e.x, e.y);
    }),
    (T.fromCartesian4 = T.clone),
    (T.packedLength = 2),
    ...
    (T.fromArray = T.unpack),
    (T.maximumComponent = function(e) {
  ...
  T.lerp = function(e, t, n, a) {
    return (
      T.multiplyByScalar(t, n, P),
      (a = T.multiplyByScalar(e, 1 - n, a)),
      T.add(P, a, a)
    );
  };
  var N = new T(),
  ...
  T.angleBetween = function(e, t) {
    return (
      T.normalize(e, N),
      T.normalize(t, U),
      b.CesiumMath.acosClamped(T.dot(N, U))
    );
  };
  var L = new T();
  (T.mostOrthogonalAxis = function(e, t) {
    ...
    return (
      T.abs(n, n),
      (t = n.x <= n.y ? T.clone(T.UNIT_X, t) : T.clone(T.UNIT_Y, t))
    );
  }),
    (T.equals = function(e, t) {
      return (
        e === t || (R.defined(e) && R.defined(t) && e.x === t.x && e.y === t.y)
      );
    }),
    ...
    (T.ZERO = Object.freeze(new T(0, 0))),
    (T.UNIT_X = Object.freeze(new T(1, 0))),
    (T.UNIT_Y = Object.freeze(new T(0, 1))),
