...
define([
  ...
  var s = {
      octEncodeInRange: function(t, o, e) {
        if (
          ...
          var n = e.x,
            a = e.y;
          (e.x = (1 - Math.abs(a)) * r.CesiumMath.signNotZero(n)),
            (e.y = (1 - Math.abs(n)) * r.CesiumMath.signNotZero(a));
        }
        return (
          (e.x = r.CesiumMath.toSNorm(e.x, o)),
          (e.y = r.CesiumMath.toSNorm(e.y, o)),
          e
        );
      },
  ...
  (s.octEncodeToCartesian4 = function(t, o) {
    ...
    (s.octDecodeInRange = function(t, o, e, n) {
      if (
        ((n.x = r.CesiumMath.fromSNorm(t, e)),
        (n.y = r.CesiumMath.fromSNorm(o, e)),
        (n.z = 1 - (Math.abs(n.x) + Math.abs(n.y))),
        n.z < 0)
      ) {
        var a = n.x;
        (n.x = (1 - Math.abs(n.y)) * r.CesiumMath.signNotZero(a)),
          (n.y = (1 - Math.abs(a)) * r.CesiumMath.signNotZero(n.y));
      }
  ...
  (s.octEncodeFloat = function(t) {
    ...
    (s.zigZagDeltaDecode = function(t, o, e) {
      for (var n = t.length, a = 0, r = 0, c = 0, i = 0; i < n; ++i)
        (a += d(t[i])),
          (r += d(o[i])),
          (t[i] = a),
          (o[i] = r),
          u.defined(e) && ((c += d(e[i])), (e[i] = c));
    }),
