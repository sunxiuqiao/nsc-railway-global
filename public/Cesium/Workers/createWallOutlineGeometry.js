...
define([
...
], function(P, e, G, L, x, i, t, T, V, D, I, a, n, r, o, s, l, d, S) {
  'use strict';
  var R = new L.Cartesian3(),
    M = new L.Cartesian3();
  function m(e) {
    var i = (e = P.defaultValue(e, P.defaultValue.EMPTY_OBJECT)).positions,
      t = e.maximumHeights,
      a = e.minimumHeights,
      n = P.defaultValue(e.granularity, G.CesiumMath.RADIANS_PER_DEGREE),
    ...
    P.defined(a) && (o += a.length),
      P.defined(t) && (o += t.length),
  ...
  m.pack = function(e, i, t) {
    ...
    if (((r = P.defined(o) ? o.length : 0), (i[t++] = r), P.defined(o)))
      for (a = 0; a < r; ++a) i[t++] = o[a];
    var s = e._maximumHeights;
    if (((r = P.defined(s) ? s.length : 0), (i[t++] = r), P.defined(s)))
      for (a = 0; a < r; ++a) i[t++] = s[a];
    return (
      L.Ellipsoid.pack(e._ellipsoid, i, t),
      (i[(t += L.Ellipsoid.packedLength)] = e._granularity),
      i
    );
  };
  ...
  return (
    (m.unpack = function(e, i, t) {
      ...
      var n,
        ...
        o = e[i++],
        s = new Array(o);
      for (a = 0; a < o; ++a, i += L.Cartesian3.packedLength)
        s[a] = L.Cartesian3.unpack(e, i);
      if (0 < (o = e[i++]))
        for (n = new Array(o), a = 0; a < o; ++a) n[a] = e[i++];
      if (0 < (o = e[i++]))
        for (r = new Array(o), a = 0; a < o; ++a) r[a] = e[i++];
      var l = L.Ellipsoid.unpack(e, i, u),
    ...
    (m.fromConstantHeights = function(e) {
      var i,
        t,
        a = (e = P.defaultValue(e, P.defaultValue.EMPTY_OBJECT)).positions,
        n = e.minimumHeight,
        r = e.maximumHeight,
        o = P.defined(n),
        s = P.defined(r);
    ...
    (m.createGeometry = function(e) {
      ...
      if (P.defined(o)) {
        ...
        for (m /= 3, s = 0; s < m; ++s) {
          var c = 3 * s,
            h = L.Cartesian3.fromArray(d, c, R),
            g = L.Cartesian3.fromArray(l, c, M);
          (p[f++] = g.x),
            (p[f++] = g.y),
            (p[f++] = g.z),
            (p[f++] = h.x),
        ...
        for (s = 0; s < v - 2; s += 2) {
          var C = s,
            H = s + 2,
            A = L.Cartesian3.fromArray(p, 3 * C, R),
            b = L.Cartesian3.fromArray(p, 3 * H, M);
