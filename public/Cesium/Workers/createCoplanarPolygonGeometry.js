...
define([
  ...
  './CoplanarPolygonGeometryLibrary-362fc2fc',
  './ArcType-66bc286a',
  ...
  function Z(e, t, a, n, r, o, i, l) {
    ...
    p.length < 3 && (p = [0, 1, 2]);
    var c = O.IndexDatatype.createTypedArray(s.length, p.length);
    c.set(p);
    var y = q;
    if (0 !== n) {
      var m = I.Quaternion.fromAxisAngle(o, n, Y);
      if (((y = I.Matrix3.fromQuaternion(m, y)), t.tangent || t.bitangent)) {
        m = I.Quaternion.fromAxisAngle(o, -n, Y);
        var u = I.Matrix3.fromQuaternion(m, J);
        (i = R.Cartesian3.normalize(I.Matrix3.multiplyByVector(u, i, i), i)),
          t.bitangent &&
            (l = R.Cartesian3.normalize(R.Cartesian3.cross(o, i, l), l));
      }
    } else y = I.Matrix3.clone(I.Matrix3.IDENTITY, y);
    var d = Q;
    ...
    for (
      var g = s.length,
        ...
        h = t.normal ? new Float32Array(b) : void 0,
        f = t.tangent ? new Float32Array(b) : void 0,
        C = t.bitangent ? new Float32Array(b) : void 0,
        x = t.st ? new Float32Array(2 * g) : void 0,
        P = 0,
        w = 0,
        A = 0,
        F = 0,
      ...
      if (((v[P++] = E.x), (v[P++] = E.y), (v[P++] = E.z), t.st)) {
        var T = r(I.Matrix3.multiplyByVector(y, E, S), N);
        R.Cartesian2.subtract(T, d, T);
        var D = V.CesiumMath.clamp(T.x / a.width, 0, 1),
          _ = V.CesiumMath.clamp(T.y / a.height, 0, 1);
        (x[G++] = D), (x[G++] = _);
      }
      t.normal && ((h[w++] = o.x), (h[w++] = o.y), (h[w++] = o.z)),
        t.tangent && ((f[F++] = i.x), (f[F++] = i.y), (f[F++] = i.z)),
        t.bitangent && ((C[A++] = l.x), (C[A++] = l.y), (C[A++] = l.z));
    }
    var k = new B.GeometryAttributes();
    return (
      t.position &&
        (k.position = new H.GeometryAttribute({
          componentDatatype: M.ComponentDatatype.DOUBLE,
          componentsPerAttribute: 3,
          values: v,
        })),
      t.normal &&
        (k.normal = new H.GeometryAttribute({
          componentDatatype: M.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: h,
        })),
      t.tangent &&
        (k.tangent = new H.GeometryAttribute({
          componentDatatype: M.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: f,
        })),
      t.bitangent &&
        (k.bitangent = new H.GeometryAttribute({
          componentDatatype: M.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: C,
        })),
      t.st &&
        (k.st = new H.GeometryAttribute({
          componentDatatype: M.ComponentDatatype.FLOAT,
  ...
  (d.fromPositions = function(e) {
    ...
    (d.pack = function(e, t, a) {
      return (
        ...
        (a = L.PolygonGeometryLibrary.packPolygonHierarchy(
          e._polygonHierarchy,
          t,
          a,
        )),
  ...
  var g = R.Ellipsoid.clone(R.Ellipsoid.UNIT_SPHERE),
    b = new p.VertexFormat(),
    v = { polygonHierarchy: {} };
  return (
    (d.unpack = function(e, t, a) {
      ...
      var o = p.VertexFormat.unpack(e, t, b);
      t += p.VertexFormat.packedLength;
      var i = e[t++],
        l = e[t];
      return (
        s.defined(a) || (a = new d(v)),
        (a._polygonHierarchy = n),
        (a._ellipsoid = R.Ellipsoid.clone(r, a._ellipsoid)),
        (a._vertexFormat = p.VertexFormat.clone(o, a._vertexFormat)),
        (a._stRotation = i),
        (a.packedLength = l),
        a
      );
    ...
    (d.createGeometry = function(e) {
      ...
      if (
        !(
          (r = F.arrayRemoveDuplicates(r, R.Cartesian3.equalsEpsilon, !0))
            .length < 3
        )
      ) {
        var o = T,
          ...
          p = U;
        if (
          G.CoplanarPolygonGeometryLibrary.computeProjectTo2DArguments(
            r,
            k,
            s,
            p,
          ...
          if (
            ...
            !R.Cartesian3.equalsEpsilon(
              k,
              R.Cartesian3.ZERO,
              V.CesiumMath.EPSILON6,
            ))
          ) {
            var c = e._ellipsoid.geodeticSurfaceNormal(k, W);
            R.Cartesian3.dot(o, c) < 0 &&
              ((o = R.Cartesian3.negate(o, o)),
              (s = R.Cartesian3.negate(s, s)));
          }
          var y = G.CoplanarPolygonGeometryLibrary.createProjectPointsTo2DFunction(
              k,
              s,
              p,
            ),
            m = G.CoplanarPolygonGeometryLibrary.createProjectPointTo2DFunction(
              k,
              s,
              p,
            );
          ...
          var u = L.PolygonGeometryLibrary.polygonsFromHierarchy(a, y, !1),
            d = u.hierarchy,
            g = u.polygons;
          if (0 !== d.length) {
            r = d[0].outerRing;
            for (
              var b = I.BoundingSphere.fromPoints(r),
                v = L.PolygonGeometryLibrary.computeBoundingRectangle(
                  o,
                  m,
                  r,
                  n,
              ...
              var C = new A.GeometryInstance({
                geometry: Z(g[f], t, v, n, m, o, i, l),
              });
              h.push(C);
            }
            var x = w.GeometryPipeline.combineInstances(h)[0];
            (x.attributes.position.values = new Float64Array(
              x.attributes.position.values,
            )),
              (x.indices = O.IndexDatatype.createTypedArray(
                x.attributes.position.values.length / 3,
                x.indices,
              ));
            var P = x.attributes;
            return (
