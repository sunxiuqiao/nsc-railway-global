...
define([
...
], function(t, y, e, f, b, v, s, x) {
  'use strict';
  function i(t, e) {
    (this._ellipsoid = t),
      (this._cameraPosition = new b.Cartesian3()),
      (this._cameraPositionInScaledSpace = new b.Cartesian3()),
    ...
    cameraPosition: {
      ...
      set: function(t) {
        var e = this._ellipsoid.transformPositionToScaledSpace(
          ...
          i = b.Cartesian3.magnitudeSquared(e) - 1;
        b.Cartesian3.clone(t, this._cameraPosition),
          (this._cameraPositionInScaledSpace = e),
          (this._distanceToLimbInScaledSpaceSquared = i);
      },
    },
  });
  var c = new b.Cartesian3();
  ...
  var o = b.Ellipsoid.clone(b.Ellipsoid.UNIT_SPHERE);
  ...
  i.prototype.computeHorizonCullingPointFromRectangle = function(t, e, i) {
    var r = b.Rectangle.subsample(t, e, 0, m),
      a = v.BoundingSphere.fromPoints(r);
    if (!(b.Cartesian3.magnitude(a.center) < 0.1 * e.minimumRadius))
      return this.computeHorizonCullingPoint(a.center, r, i);
  };
  var a = new b.Cartesian3();
  function u(t, e, i) {
    if (y.defined(e) && e < 0 && t.minimumRadius > -e) {
      var r = b.Cartesian3.fromElements(
        t.radii.x + e,
        t.radii.y + e,
        t.radii.z + e,
        a,
      );
      t = b.Ellipsoid.fromCartesian3(r, i);
    }
    return t;
  }
  function d(t, e, i, r) {
    y.defined(r) || (r = new b.Cartesian3());
    for (var a = T(t, e), n = 0, o = 0, s = i.length; o < s; ++o) {
      var c = M(t, i[o], a);
      if (c < 0) return;
      n = Math.max(n, c);
    }
  ...
  var l = new b.Cartesian3();
  function p(t, e, i, r, a, n) {
    y.defined(n) || (n = new b.Cartesian3()),
      (r = y.defaultValue(r, 3)),
      (a = y.defaultValue(a, b.Cartesian3.ZERO));
    for (var o = T(t, e), s = 0, c = 0, m = i.length; c < m; c += r) {
      (l.x = i[c] + a.x), (l.y = i[c + 1] + a.y), (l.z = i[c + 2] + a.z);
      var u = M(t, l, o);
      if (u < 0) return;
      s = Math.max(s, u);
    }
  ...
  function h(t, e, i) {
    var r = e,
      a = i,
      n = b.Cartesian3.subtract(t, r, c),
      o = -b.Cartesian3.dot(n, r);
    return !(a < 0
      ? 0 < o
      : a < o && (o * o) / b.Cartesian3.magnitudeSquared(n) > a);
  }
  var C = new b.Cartesian3(),
    S = new b.Cartesian3();
  function M(t, e, i) {
    var r = t.transformPositionToScaledSpace(e, C),
      a = b.Cartesian3.magnitudeSquared(r),
      n = Math.sqrt(a),
      o = b.Cartesian3.divideByScalar(r, n, S);
    a = Math.max(1, a);
    var s = 1 / (n = Math.max(1, n));
    return (
      1 /
      (b.Cartesian3.dot(o, i) * s -
        b.Cartesian3.magnitude(b.Cartesian3.cross(o, i, o)) *
          (Math.sqrt(a - 1) * s))
    );
  }
  function g(t, e, i) {
    if (!(e <= 0 || e === 1 / 0 || e != e))
      return b.Cartesian3.multiplyByScalar(t, e, i);
  }
  var r = new b.Cartesian3();
  function T(t, e) {
    return b.Cartesian3.equals(e, b.Cartesian3.ZERO)
      ? e
      : (t.transformPositionToScaledSpace(e, r), b.Cartesian3.normalize(r, r));
  }
  ...
  function w(t, e, i, r, a, n) {
    ...
    if (y.defined(t) && y.defined(e) && y.defined(i) && y.defined(r)) {
      var u = t.minimum,
        d = t.maximum,
        l = b.Cartesian3.subtract(d, u, E),
        p = i - e;
      (m =
        Math.max(b.Cartesian3.maximumComponent(l), p) < _ - 1
          ? P.BITS12
          : P.NONE),
        (o = t.center),
        (s = v.Matrix4.inverseTransformation(r, new v.Matrix4()));
      var h = b.Cartesian3.negate(u, z);
      v.Matrix4.multiply(v.Matrix4.fromTranslation(h, I), s, s);
      var f = z;
      (f.x = 1 / l.x),
        (f.y = 1 / l.y),
        (f.z = 1 / l.z),
        v.Matrix4.multiply(v.Matrix4.fromScale(f, I), s, s),
        (c = v.Matrix4.clone(r)),
        v.Matrix4.setTranslation(c, b.Cartesian3.ZERO, c),
        (r = v.Matrix4.clone(r, new v.Matrix4()));
      var x = v.Matrix4.fromTranslation(u, I),
        C = v.Matrix4.fromScale(l, B),
        S = v.Matrix4.multiply(x, C, I);
      v.Matrix4.multiply(r, S, r), v.Matrix4.multiply(c, S, c);
    }
    (this.quantization = m),
      ...
      (this.hasWebMercatorT = y.defaultValue(n, !1));
  }
  (w.prototype.encode = function(t, e, i, r, a, n, o) {
    var s = r.x,
      c = r.y;
    if (this.quantization === P.BITS12) {
      ((i = v.Matrix4.multiplyByPoint(
        this.toScaledENU,
        i,
        z,
      )).x = f.CesiumMath.clamp(i.x, 0, 1)),
        (i.y = f.CesiumMath.clamp(i.y, 0, 1)),
        (i.z = f.CesiumMath.clamp(i.z, 0, 1));
      var m = this.maximumHeight - this.minimumHeight,
        u = f.CesiumMath.clamp((a - this.minimumHeight) / m, 0, 1);
      b.Cartesian2.fromElements(i.x, i.y, N);
      var d = x.AttributeCompression.compressTextureCoordinates(N);
      b.Cartesian2.fromElements(i.z, u, N);
      var l = x.AttributeCompression.compressTextureCoordinates(N);
      b.Cartesian2.fromElements(s, c, N);
      var p = x.AttributeCompression.compressTextureCoordinates(N);
      if (((t[e++] = d), (t[e++] = l), (t[e++] = p), this.hasWebMercatorT)) {
        b.Cartesian2.fromElements(o, 0, N);
        var h = x.AttributeCompression.compressTextureCoordinates(N);
        t[e++] = h;
      }
    } else
      b.Cartesian3.subtract(i, this.center, z),
        (t[e++] = z.x),
        (t[e++] = z.y),
        (t[e++] = z.z),
        (t[e++] = a),
    ...
    return (
      this.hasVertexNormals &&
        (t[e++] = x.AttributeCompression.octPackFloat(n)),
      e
    );
  }),
    (w.prototype.decodePosition = function(t, e, i) {
      if (
        (y.defined(i) || (i = new b.Cartesian3()),
        (e *= this.getStride()),
        ...
        return (
          ...
          (i.y = t[e + 1]),
          (i.z = t[e + 2]),
          b.Cartesian3.add(i, this.center, i)
        );
      var r = x.AttributeCompression.decompressTextureCoordinates(t[e], N);
      (i.x = r.x), (i.y = r.y);
      var a = x.AttributeCompression.decompressTextureCoordinates(t[e + 1], N);
      return (i.z = a.x), v.Matrix4.multiplyByPoint(this.fromScaledENU, i, i);
    }),
    (w.prototype.decodeTextureCoordinates = function(t, e, i) {
      return (
        y.defined(i) || (i = new b.Cartesian2()),
        (e *= this.getStride()),
        this.quantization === P.BITS12
          ? x.AttributeCompression.decompressTextureCoordinates(t[e + 2], i)
          : b.Cartesian2.fromElements(t[e + 4], t[e + 5], i)
      );
    }),
    (w.prototype.decodeHeight = function(t, e) {
      return (
        ...
        this.quantization !== P.BITS12
          ? t[e + 3]
          : x.AttributeCompression.decompressTextureCoordinates(t[e + 1], N).y *
    ...
    (w.prototype.decodeWebMercatorT = function(t, e) {
      return (
        (e *= this.getStride()),
        this.quantization === P.BITS12
          ? x.AttributeCompression.decompressTextureCoordinates(t[e + 3], N).x
          : t[e + 6]
      );
    }),
    (w.prototype.getOctEncodedNormal = function(t, e, i) {
      var r = t[(e = (e + 1) * this.getStride() - 1)] / 256,
        a = Math.floor(r),
        n = 256 * (r - a);
      return b.Cartesian2.fromElements(a, n, i);
    }),
  ...
  (w.prototype.getAttributes = function(t) {
    ...
    (w.prototype.getAttributeLocations = function() {
      return this.quantization === P.NONE ? A : q;
    }),
    (w.clone = function(t, e) {
      return (
        ...
        (e.center = b.Cartesian3.clone(t.center)),
