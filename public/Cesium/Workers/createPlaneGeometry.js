...
], function(n, e, t, c, p, r, a, y, s, A, o) {
  'use strict';
  function i(e) {
    e = n.defaultValue(e, n.defaultValue.EMPTY_OBJECT);
    var t = n.defaultValue(e.vertexFormat, o.VertexFormat.DEFAULT);
    (this._vertexFormat = t), (this._workerName = 'createPlaneGeometry');
  }
  (i.packedLength = o.VertexFormat.packedLength),
    (i.pack = function(e, t, r) {
      return (
        (r = n.defaultValue(r, 0)),
        o.VertexFormat.pack(e._vertexFormat, t, r),
        t
      );
    });
  var m = new o.VertexFormat(),
    u = { vertexFormat: m };
  i.unpack = function(e, t, r) {
    t = n.defaultValue(t, 0);
    var a = o.VertexFormat.unpack(e, t, m);
    return n.defined(r)
      ? ((r._vertexFormat = o.VertexFormat.clone(a, r._vertexFormat)), r)
      : new i(u);
  };
  var l = new c.Cartesian3(-0.5, -0.5, 0),
    F = new c.Cartesian3(0.5, 0.5, 0);
  return (
    (i.createGeometry = function(e) {
      ...
      if (a.position) {
        if (
          ...
          (o[0] = 0),
            ...
            (o[10] = 0),
            (o[11] = 1),
            (n.normal = new s.GeometryAttribute({
        ...
        if (a.tangent) {
          ...
          (m[0] = 1),
            ...
            (m[10] = 0),
            (m[11] = 0),
            (n.tangent = new s.GeometryAttribute({
              componentDatatype: y.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: m,
            }));
        ...
        if (a.bitangent) {
          ...
          (u[0] = 0),
            ...
            (u[10] = 1),
            (u[11] = 0),
            (n.bitangent = new s.GeometryAttribute({
              componentDatatype: y.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: u,
            }));
      ...
      return new s.Geometry({
        ...
        boundingSphere: new p.BoundingSphere(c.Cartesian3.ZERO, Math.sqrt(2)),
      });
    }),
    function(e, t) {
      return n.defined(t) && (e = i.unpack(e, t)), i.createGeometry(e);
    }
  );
});
