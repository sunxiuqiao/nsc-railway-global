...
define([
  ...
  'use strict';
  function x(t, e, n, i) {
    (this.x = f.defaultValue(t, 0)),
      (this.y = f.defaultValue(e, 0)),
      (this.width = f.defaultValue(n, 0)),
      (this.height = f.defaultValue(i, 0));
  }
  (x.packedLength = 4),
    (x.pack = function(t, e, n) {
      return (
        (n = f.defaultValue(n, 0)),
        (e[n++] = t.x),
        (e[n++] = t.y),
        (e[n++] = t.width),
        (e[n] = t.height),
    ...
    (x.fromPoints = function(t, e) {
      if ((f.defined(e) || (e = new x()), !f.defined(t) || 0 === t.length))
        return (e.x = 0), (e.y = 0), (e.width = 0), (e.height = 0), e;
      for (
        var n = t.length, i = t[0].x, h = t[0].y, r = t[0].x, a = t[0].y, d = 1;
        d < n;
        d++
      ) {
        var u = t[d],
  ...
  var d = new a.GeographicProjection(),
    u = new r.Cartographic(),
    c = new r.Cartographic();
  (x.fromRectangle = function(t, e, n) {
    if ((f.defined(n) || (n = new x()), !f.defined(t)))
      return (n.x = 0), (n.y = 0), (n.width = 0), (n.height = 0), n;
    var i = (e = f.defaultValue(e, d)).project(r.Rectangle.southwest(t, u)),
      h = e.project(r.Rectangle.northeast(t, c));
    return (
      r.Cartesian2.subtract(h, i, h),
      (n.x = i.x),
      (n.y = i.y),
      (n.width = h.x),
      (n.height = h.y),
      ...
      if (f.defined(t))
        return f.defined(e)
          ? ((e.x = t.x),
            ...
            (e.height = t.height),
            e)
          : new x(t.x, t.y, t.width, t.height);
    }),
