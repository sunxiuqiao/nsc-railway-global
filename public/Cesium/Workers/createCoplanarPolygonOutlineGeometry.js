...
define([
  ...
  function E(e) {
    for (
      var t = e.length,
        ...
        n = f.IndexDatatype.createTypedArray(t, 2 * t),
        o = 0,
        a = 0,
        i = 0;
      i < t;
    ...
    var c = new d.GeometryAttributes({
  ...
  function k(e) {
    var t = (e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT))
      .polygonHierarchy;
    (this._polygonHierarchy = t),
      (this._workerName = 'createCoplanarPolygonOutlineGeometry'),
      (this.packedLength =
        T.PolygonGeometryLibrary.computeHierarchyPackedLength(t) + 1);
  }
  (k.fromPositions = function(e) {
    return new k({
      polygonHierarchy: {
        positions: (e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT))
          .positions,
      },
    });
  }),
  ...
  return (
    ...
    (k.createGeometry = function(e) {
      ...
      if (
        !(
          (r = b.arrayRemoveDuplicates(r, l.Cartesian3.equalsEpsilon, !0))
            .length < 3
        ) &&
        G.CoplanarPolygonGeometryLibrary.validOutline(r)
      ) {
        ...
        if (0 !== n.length) {
          ...
          var y = m.GeometryPipeline.combineInstances(o)[0],
            c = p.BoundingSphere.fromPoints(t.positions);
          return new u.Geometry({
