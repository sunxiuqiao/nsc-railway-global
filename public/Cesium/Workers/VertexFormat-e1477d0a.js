 ...
 */
define(['exports', './when-a55a8a4c', './Check-bc1d37d9'], function(e, o, t) {
  'use strict';
  function a(e) {
  ...
  (a.POSITION_ONLY = Object.freeze(new a({ position: !0 }))),
    (a.POSITION_AND_NORMAL = Object.freeze(
      new a({ position: !0, normal: !0 }),
    )),
    (a.POSITION_NORMAL_AND_ST = Object.freeze(
      new a({ position: !0, normal: !0, st: !0 }),
    )),
    (a.POSITION_AND_ST = Object.freeze(new a({ position: !0, st: !0 }))),
    (a.POSITION_AND_COLOR = Object.freeze(new a({ position: !0, color: !0 }))),
    (a.ALL = Object.freeze(
