...
define([
  ...
  './Color-06be9049',
], function(J, e, j, K, Q, t, r, X, Z, $, ee, a, o, y, te, re, n, i, ae, oe) {
  'use strict';
  var ne = [];
  function ie(e, t, r, a, o) {
    ...
    var h = (d - l) / o,
      ...
      C = (m - c) / o;
    for (n = 0; n < o; n++)
      i[n] = new oe.Color(l + n * h, s + n * f, p + n * v, c + n * C);
    return i;
  }
  function m(e) {
    var t = (e = J.defaultValue(e, J.defaultValue.EMPTY_OBJECT)).positions,
      r = e.colors,
      a = J.defaultValue(e.width, 1),
      o = J.defaultValue(e.colorsPerVertex, !1);
    (this._positions = t),
      (this._colors = r),
      (this._width = a),
      (this._colorsPerVertex = o),
      (this._vertexFormat = y.VertexFormat.clone(
        J.defaultValue(e.vertexFormat, y.VertexFormat.DEFAULT),
      )),
      (this._arcType = J.defaultValue(e.arcType, re.ArcType.GEODESIC)),
      (this._granularity = J.defaultValue(
        e.granularity,
        j.CesiumMath.RADIANS_PER_DEGREE,
      )),
      (this._ellipsoid = K.Ellipsoid.clone(
        J.defaultValue(e.ellipsoid, K.Ellipsoid.WGS84),
      )),
      (this._workerName = 'createPolylineGeometry');
    var n = 1 + t.length * K.Cartesian3.packedLength;
    (n += J.defined(r) ? 1 + r.length * oe.Color.packedLength : 1),
      (this.packedLength =
        n + K.Ellipsoid.packedLength + y.VertexFormat.packedLength + 4);
  }
  m.pack = function(e, t, r) {
    ...
    var i = e._colors;
    for (
      n = J.defined(i) ? i.length : 0, t[r++] = n, a = 0;
      a < n;
      ++a, r += oe.Color.packedLength
    )
  ...
  m.unpack = function(e, t, r) {
    ...
    var o = e[t++],
      n = new Array(o);
    for (a = 0; a < o; ++a, t += K.Cartesian3.packedLength)
      n[a] = K.Cartesian3.unpack(e, t);
    var i = 0 < (o = e[t++]) ? new Array(o) : void 0;
    for (a = 0; a < o; ++a, t += oe.Color.packedLength)
      i[a] = oe.Color.unpack(e, t);
    var l = K.Ellipsoid.unpack(e, t, h);
    t += K.Ellipsoid.packedLength;
    var s = y.VertexFormat.unpack(e, t, f);
  ...
  return (
    (m.createGeometry = function(e) {
      var t,
        ...
        p = e._granularity,
        c = e._ellipsoid,
        d = te.arrayRemoveDuplicates(e._positions, K.Cartesian3.equalsEpsilon),
        u = d.length;
      if (!(u < 2 || o <= 0)) {
        if (s === re.ArcType.GEODESIC || s === re.ArcType.RHUMB) {
          ...
          m =
            s === re.ArcType.GEODESIC
              ? ((y = j.CesiumMath.chordLength(p, c.maximumRadius)),
                ae.PolylinePipeline.numberOfPoints)
              : ((y = p), ae.PolylinePipeline.numberOfPointsRhumbLine);
          var h = ae.PolylinePipeline.extractHeights(d, c);
          if (J.defined(i)) {
            var f = 1;
            for (t = 0; t < u - 1; ++t) f += m(d[t], d[t + 1], y);
            var v = new Array(f),
              C = 0;
            for (t = 0; t < u - 1; ++t) {
              var g = d[t],
        ...
        for (r = 0; r < u; ++r) {
          ...
          0 === r
            ? ((w = le),
              K.Cartesian3.subtract(d[0], d[1], w),
              K.Cartesian3.add(d[0], w, w))
            : (w = d[r - 1]),
            K.Cartesian3.clone(w, pe),
            K.Cartesian3.clone(d[r], se),
            r === u - 1
              ? ((w = le),
                K.Cartesian3.subtract(d[u - 1], d[u - 2], w),
                K.Cartesian3.add(d[u - 1], w, w))
              : (w = d[r + 1]),
            K.Cartesian3.clone(w, ce),
            J.defined(F) &&
              ((S = 0 === r || l ? i[r] : i[r - 1]), r !== u - 1 && (B = i[r]));
          var U = r === u - 1 ? 2 : 4;
          for (a = 0 === r ? 2 : 0; a < U; ++a) {
            K.Cartesian3.pack(se, x, G),
              K.Cartesian3.pack(pe, k, G),
              K.Cartesian3.pack(ce, D, G),
              (G += 3);
            var N = a - 2 < 0 ? -1 : 1;
            if (
              ((V[O++] = (a % 2) * 2 - 1),
              (V[O++] = N * o),
              n.st &&
                ((L[R++] = r / (u - 1)), (L[R++] = Math.max(V[O - 2], 0))),
              J.defined(F))
            ) {
              var M = a < 2 ? S : B;
              (F[I++] = oe.Color.floatToByte(M.red)),
                (F[I++] = oe.Color.floatToByte(M.green)),
                (F[I++] = oe.Color.floatToByte(M.blue)),
                (F[I++] = oe.Color.floatToByte(M.alpha));
            }
          }
        }
        ...
        return new Z.Geometry({
          ...
          boundingSphere: Q.BoundingSphere.fromPoints(d),
