...
define([
...
], function(e, v, t, f, P, k, C, w, b, A, c) {
  'use strict';
  function m(e, t, r) {
    (e = v.defaultValue(e, 0)),
  ...
  function x(e) {
    var t,
      ...
      d = e.compressVertices,
      p = e.modelMatrix,
      u = n.length;
    for (t = 0; t < u; ++t)
      if (v.defined(n[t].geometry)) {
    ...
    if (
      (!(function(e, t, r) {
        ...
        if (!i && 1 < o) {
          ...
          for (n = 1; n < o; ++n)
            if (!P.Matrix4.equals(a, e[n].modelMatrix)) {
              i = !0;
              break;
            }
        }
        if (i)
          for (n = 0; n < o; ++n)
            v.defined(e[n].geometry) &&
              b.GeometryPipeline.transformToWorldCoordinates(e[n]);
        else P.Matrix4.multiplyTransformation(t, e[0].modelMatrix, t);
      })(n, p, a),
      !a)
    )
      for (t = 0; t < u; ++t)
        v.defined(n[t].geometry) && b.GeometryPipeline.splitLongitude(n[t]);
    if (
      (!(function(e) {
        for (var t = e.length, r = 0; r < t; ++r) {
          var n = e[r];
          v.defined(n.geometry)
            ? G(n.geometry, r)
            : v.defined(n.westHemisphereGeometry) &&
              v.defined(n.eastHemisphereGeometry) &&
              (G(n.westHemisphereGeometry, r), G(n.eastHemisphereGeometry, r));
        }
      })(n),
      s)
    )
      for (t = 0; t < u; ++t) {
        var f = n[t];
        v.defined(f.geometry)
          ? (b.GeometryPipeline.reorderForPostVertexCache(f.geometry),
            b.GeometryPipeline.reorderForPreVertexCache(f.geometry))
          : v.defined(f.westHemisphereGeometry) &&
            v.defined(f.eastHemisphereGeometry) &&
            (b.GeometryPipeline.reorderForPostVertexCache(
              f.westHemisphereGeometry,
            ),
    ...
    for (u = c.length, t = 0; t < u; ++t) {
      ...
      if (a)
        for (m in h)
          h.hasOwnProperty(m) &&
            h[m].componentDatatype === k.ComponentDatatype.DOUBLE &&
            b.GeometryPipeline.encodeAttribute(r, m, m + '3DHigh', m + '3DLow');
      else
        for (m in h)
          if (
            h.hasOwnProperty(m) &&
            ...
            var l = m + '3D',
              g = m + '2D';
            b.GeometryPipeline.projectTo2D(r, m, l, g, i),
              v.defined(r.boundingSphere) &&
                'position' === m &&
                (r.boundingSphereCV = P.BoundingSphere.fromVertices(
                  r.attributes.position2D.values,
                )),
              b.GeometryPipeline.encodeAttribute(r, l, l + 'High', l + 'Low'),
              b.GeometryPipeline.encodeAttribute(r, g, g + 'High', g + 'Low');
          }
    ...
    if (!o) {
      ...
      for (u = c.length, t = 0; t < u; ++t)
        (r = c[t]),
          (y = y.concat(b.GeometryPipeline.fitToUnsignedShortIndices(r)));
      c = y;
    }
    return c;
  }
  function S(e, t, r, n) {
    ...
    for (var p = e.length, u = 0; u < p; ++u) {
      var f = e[u][t];
      if (v.defined(f)) {
        var c = f.indices.length;
        o < i + c && ((i = 0), (o = r[++a].indices.length)),
          n.push({ index: a, offset: i, count: c }),
          (i += c);
      }
    }
  }
  Object.defineProperties(m.prototype, {
    ...
    (m.toValue = function(e, t) {
      return (
        v.defined(t) || (t = new Float32Array([e.x, e.y, e.z])),
        (t[0] = e.x),
        (t[1] = e.y),
        (t[2] = e.z),
        t
  ...
  (h.combineGeometry = function(e) {
    ...
    0 < p &&
      (0 < (t = x(e)).length &&
        ...
        e.createPickOffsets &&
          (S((o = d), 'geometry', (a = t), (s = [])),
          S(o, 'westHemisphereGeometry', a, s),
          S(o, 'eastHemisphereGeometry', a, s),
          (n = s))),
      v.defined(d[0].attributes) &&
        v.defined(d[0].attributes.offset) &&
        ((i = new Array(p)), (u = !0)));
    for (var f = new Array(p), c = new Array(p), m = 0; m < p; ++m) {
      var h = d[m],
        l = h.geometry;
      v.defined(l) &&
        ((f[m] = l.boundingSphere),
        (c[m] = l.boundingSphereCV),
        u && (i[m] = h.geometry.offsetAttribute));
      var g = h.eastHemisphereGeometry,
        y = h.westHemisphereGeometry;
      v.defined(g) &&
        v.defined(y) &&
        (v.defined(g.boundingSphere) &&
          v.defined(y.boundingSphere) &&
          (f[m] = P.BoundingSphere.union(g.boundingSphere, y.boundingSphere)),
        v.defined(g.boundingSphereCV) &&
          v.defined(y.boundingSphereCV) &&
          (c[m] = P.BoundingSphere.union(
            g.boundingSphereCV,
            y.boundingSphereCV,
          )));
    }
    ...
    (h.packCreateGeometryResults = function(e, t) {
            ...
            for (var t = 1, r = e.length, n = 0; n < r; n++) {
              ...
              if ((++t, v.defined(i))) {
                ...
                for (var a in ((t +=
                  ...
                  (v.defined(i.indices) ? i.indices.length : 0)),
                o)) {
                  if (o.hasOwnProperty(a) && v.defined(o[a]))
                    t += 5 + o[a].values.length;
                }
              }
            }
            return t;
      ...
      for (var s = 0; s < o; s++) {
        ...
        if (((r[a++] = p ? 1 : 0), p)) {
          (r[a++] = d.primitiveType),
            (r[a++] = d.geometryType),
            (r[a++] = v.defaultValue(d.offsetAttribute, -1));
          var u = v.defined(d.boundingSphere) ? 1 : 0;
          (r[a++] = u) && P.BoundingSphere.pack(d.boundingSphere, r, a),
            (a += P.BoundingSphere.packedLength);
          var f = v.defined(d.boundingSphereCV) ? 1 : 0;
          (r[a++] = f) && P.BoundingSphere.pack(d.boundingSphereCV, r, a),
            (a += P.BoundingSphere.packedLength);
          var c = d.attributes,
            m = [];
          for (var h in c)
            c.hasOwnProperty(h) &&
              v.defined(c[h]) &&
              (m.push(h), v.defined(i[h]) || ((i[h] = n.length), n.push(h)));
          r[a++] = m.length;
          for (var l = 0; l < m.length; l++) {
            var g = m[l],
              y = c[g];
            (r[a++] = i[g]),
              (r[a++] = y.componentDatatype),
              (r[a++] = y.componentsPerAttribute),
              (r[a++] = y.normalize ? 1 : 0),
              (r[a++] = y.values.length),
              r.set(y.values, a),
              (a += y.values.length);
      ...
      for (
        ...
        if (1 === n[a++]) {
          var s,
            ...
            h = n[a++];
          -1 === h && (h = void 0),
            1 === n[a++] && (s = P.BoundingSphere.unpack(n, a)),
            (a += P.BoundingSphere.packedLength),
            1 === n[a++] && (d = P.BoundingSphere.unpack(n, a)),
            (a += P.BoundingSphere.packedLength);
          var l,
            g = new w.GeometryAttributes(),
            y = n[a++];
          for (t = 0; t < y; t++) {
            var b = r[n[a++]],
              v = n[a++];
            f = n[a++];
            var G = 0 !== n[a++];
            (p = n[a++]), (u = k.ComponentDatatype.createTypedArray(v, p));
            for (var x = 0; x < p; x++) u[x] = n[a++];
          ...
          if (0 < (p = n[a++])) {
            var S = u.length / f;
            for (l = A.IndexDatatype.createTypedArray(S, p), t = 0; t < p; t++)
              l[t] = n[a++];
          }
          i[o++] = new C.Geometry({
            primitiveType: c,
        ...
        packedInstances: (function(e, t) {
          ...
          for (var o = 0; o < r; o++) {
            ...
            if (
              ...
              v.defined(a.attributes) && v.defined(a.attributes.offset))
            ) {
    ...
    (h.unpackCombineGeometryParameters = function(e) {
      ...
      var u = f.Ellipsoid.clone(e.ellipsoid);
      return {
        instances: t,
        ellipsoid: u,
        projection: e.isGeographic
          ? new P.GeographicProjection(u)
          : new c.WebMercatorProjection(u),
        elementIndexUintSupported: e.elementIndexUintSupported,
        scene3DOnly: e.scene3DOnly,
        vertexCacheOptimize: e.vertexCacheOptimize,
        compressVertices: e.compressVertices,
