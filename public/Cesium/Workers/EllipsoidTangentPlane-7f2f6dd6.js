...
define([
  ...
  './Plane-a6a20716',
], function(e, p, n, x, s, o, a) {
  'use strict';
  function y(e, n, t) {
    (this.minimum = x.Cartesian3.clone(p.defaultValue(e, x.Cartesian3.ZERO))),
      (this.maximum = x.Cartesian3.clone(p.defaultValue(n, x.Cartesian3.ZERO))),
      (t = p.defined(t)
        ? x.Cartesian3.clone(t)
        : x.Cartesian3.midpoint(
            this.minimum,
            this.maximum,
            new x.Cartesian3(),
          )),
  ...
  (y.fromPoints = function(e, n) {
    if ((p.defined(n) || (n = new y()), !p.defined(e) || 0 === e.length))
      return (
        (n.minimum = x.Cartesian3.clone(x.Cartesian3.ZERO, n.minimum)),
        (n.maximum = x.Cartesian3.clone(x.Cartesian3.ZERO, n.maximum)),
        (n.center = x.Cartesian3.clone(x.Cartesian3.ZERO, n.center)),
        n
      );
    for (
      var t = e[0].x,
    ...
    return (
      ...
      (C.y = s),
      (C.z = o),
      (n.center = x.Cartesian3.midpoint(h, C, n.center)),
      n
    );
  }),
    (y.clone = function(e, n) {
      if (p.defined(e))
        return p.defined(n)
          ? ((n.minimum = x.Cartesian3.clone(e.minimum, n.minimum)),
            (n.maximum = x.Cartesian3.clone(e.maximum, n.maximum)),
            (n.center = x.Cartesian3.clone(e.center, n.center)),
            n)
    ...
    (y.equals = function(e, n) {
      return (
        ...
        (p.defined(e) &&
          p.defined(n) &&
          x.Cartesian3.equals(e.center, n.center) &&
          x.Cartesian3.equals(e.minimum, n.minimum) &&
          x.Cartesian3.equals(e.maximum, n.maximum))
      );
    });
  var m = new x.Cartesian3();
  (y.intersectPlane = function(e, n) {
    m = x.Cartesian3.subtract(e.maximum, e.minimum, m);
    var t = x.Cartesian3.multiplyByScalar(m, 0.5, m),
      i = n.normal,
  ...
  function t(e, n) {
    ...
    (this._ellipsoid = n),
      (this._origin = e),
      (this._xAxis = x.Cartesian3.fromCartesian4(s.Matrix4.getColumn(t, 0, r))),
      (this._yAxis = x.Cartesian3.fromCartesian4(s.Matrix4.getColumn(t, 1, r)));
  ...
  (t.prototype.projectPointOntoPlane = function(e, n) {
    ...
    var i = o.IntersectionTests.rayPlane(t, this._plane, l);
    if (
      (p.defined(i) ||
        (x.Cartesian3.negate(t.direction, t.direction),
        (i = o.IntersectionTests.rayPlane(t, this._plane, l))),
      p.defined(i))
    ) {
      var a = x.Cartesian3.subtract(i, this._origin, i),
        r = x.Cartesian3.dot(this._xAxis, a),
    ...
    (t.prototype.projectPointsToNearestOnPlane = function(e, n) {
      ...
      n.length = t;
      for (var i = 0; i < t; i++)
        n[i] = this.projectPointToNearestOnPlane(e[i], n[i]);
      return n;
    });
  ...
  (t.prototype.projectPointOntoEllipsoid = function(e, n) {
    ...
    var t = this._ellipsoid,
      ...
      s = u;
    return (
      x.Cartesian3.multiplyByScalar(a, e.x, s),
      (n = x.Cartesian3.add(i, s, n)),
      x.Cartesian3.multiplyByScalar(r, e.y, s),
      x.Cartesian3.add(n, s, n),
      t.scaleToGeocentricSurface(n, n),
      n
    );
  }),
    (t.prototype.projectPointsOntoEllipsoid = function(e, n) {
      ...
      for (var i = 0; i < t; ++i)
        n[i] = this.projectPointOntoEllipsoid(e[i], n[i]);
      return n;
    }),
    (e.AxisAlignedBoundingBox = y),
    (e.EllipsoidTangentPlane = t);
});
